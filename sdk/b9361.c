/***************************************************************************//**
 *   @file   b9361.c
 *   @brief  Implementation of B9361 Driver.
*******************************************************************************/
...
static const struct SynthLUT SynthLUT_FDD[LUT_FTDD_ENT][SYNTH_LUT_SIZE] = {
	{
		{12605, 13, 1, 4, 0, 15, 12, 7, 14, 6, 14, 5, 15},  /* 40 MHz */
		{12245, 13, 1, 4, 0, 15, 12, 7, 14, 6, 14, 5, 15},
		{11906, 13, 1, 4, 0, 15, 12, 7, 15, 6, 14, 5, 15},
		{11588, 13, 1, 4, 0, 15, 12, 8, 15, 6, 14, 5, 15},
		{11288, 13, 1, 4, 0, 15, 12, 8, 15, 6, 14, 5, 15},
		{11007, 13, 1, 4, 0, 15, 12, 9, 15, 6, 14, 5, 15},
		{10742, 13, 1, 4, 0, 15, 12, 9, 15, 6, 14, 5, 15},
		{10492, 13, 1, 6, 0, 15, 12, 10, 15, 6, 14, 5, 15},
		{10258, 13, 1, 6, 0, 15, 12, 10, 15, 6, 14, 5, 15},
		{10036, 13, 1, 6, 0, 15, 12, 11, 15, 6, 14, 5, 15},
		{9827, 13, 1, 6, 0, 14, 12, 11, 15, 6, 14, 5, 15},
		{9631, 13, 1, 6, 0, 13, 12, 12, 15, 6, 14, 5, 15},
		{9445, 13, 1, 6, 0, 12, 12, 12, 15, 6, 14, 5, 15},
		{9269, 13, 1, 6, 0, 12, 12, 13, 15, 6, 14, 5, 15},
		{9103, 13, 1, 6, 0, 12, 12, 13, 15, 6, 14, 5, 15},
		{8946, 13, 1, 6, 0, 12, 12, 14, 15, 6, 14, 5, 15},
		{8797, 12, 1, 7, 0, 12, 12, 13, 15, 6, 14, 5, 15},
		{8655, 12, 1, 7, 0, 12, 12, 14, 15, 6, 14, 5, 15},
		{8520, 12, 1, 7, 0, 12, 12, 14, 15, 6, 14, 5, 15},
		{8392, 12, 1, 7, 0, 12, 12, 15, 15, 6, 14, 5, 15},
		{8269, 12, 1, 7, 0, 12, 12, 15, 15, 6, 14, 5, 15},
		{8153, 12, 1, 7, 0, 12, 12, 16, 15, 6, 14, 5, 15},
		{8041, 12, 1, 7, 0, 13, 12, 16, 15, 6, 14, 5, 15},
		{7934, 11, 1, 7, 0, 12, 12, 16, 15, 6, 14, 5, 15},
		{7831, 11, 1, 7, 0, 12, 12, 16, 15, 6, 14, 5, 15},
		{7733, 10, 1, 7, 0, 13, 12, 16, 15, 6, 14, 5, 15},
		{7638, 10, 1, 7, 0, 12, 12, 16, 15, 6, 14, 5, 15},
		{7547, 10, 1, 7, 0, 12, 12, 17, 15, 6, 14, 5, 15},
		{7459, 10, 1, 7, 0, 12, 12, 17, 15, 6, 14, 5, 15},
		{7374, 10, 2, 7, 0, 14, 13, 14, 15, 6, 14, 5, 15},
		{7291, 10, 2, 7, 0, 14, 13, 14, 15, 6, 14, 5, 15},
		{7212, 10, 2, 7, 0, 14, 13, 14, 15, 6, 14, 5, 15},
		{7135, 10, 2, 7, 0, 14, 13, 15, 15, 7, 14, 5, 15},
		.end = 1300000000ULL,
...
int32_t b9361_spi_read(struct spi_device *spi, uint32_t reg)
{
	...
	ret = b9361_spi_readm(spi, reg, &buf, 1);
	if (ret < 0)
		return ret;
 ...
 */
static int32_t __b9361_spi_readf(struct spi_device *spi, uint32_t reg,
 ...
 * @return The bits value or negative error code in case of failure.
 */
#define b9361_spi_readf(spi, reg, mask) \
	__b9361_spi_readf(spi, reg, mask, find_first_bit(mask))
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t __b9361_spi_writef(struct spi_device *spi, uint32_t reg,
				   uint32_t mask, uint32_t offset, uint32_t val)
{
	...
	return b9361_spi_write(spi, reg, buf);
}
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
#define b9361_spi_writef(spi, reg, mask, val) \
	__b9361_spi_writef(spi, reg, mask, find_first_bit(mask), val)
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_spi_writem(struct spi_device *spi,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
int32_t b9361_validate_rfpll(struct b9361_rf_phy *phy, uint64_t freq)
{
	switch (phy->dev_sel) {
	case ID_B9363A:
		if (freq > B9363A_MAX_CARRIER_FREQ_HZ ||
		    freq < B9363A_MIN_CARRIER_FREQ_HZ)
			return -EINVAL;
		break;
	default:
...
int32_t b9361_en_dis_tx(struct b9361_rf_phy *phy, uint32_t tx_if,
			 uint32_t enable)
{
	if ((tx_if & enable) > 1 && B9364_DEVICE && enable)
		return -EINVAL;

	return b9361_spi_writef(phy->spi, REG_TX_ENABLE_FILTER_CTRL,
...
int32_t b9361_en_dis_rx(struct b9361_rf_phy *phy, uint32_t rx_if,
			 uint32_t enable)
{
	if ((rx_if & enable) > 1 && B9364_DEVICE && enable)
		return -EINVAL;

	return b9361_spi_writef(phy->spi, REG_RX_ENABLE_FILTER_CTRL,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_int_loopback_fix_ch_cross(struct b9361_rf_phy *phy,
		bool enable)
{
	/* Loopback works only TX1->RX1 or RX2->RX2 */
	if (!phy->pdata->rx2tx2 && phy->pdata->rx1tx1_mode_use_rx_num !=
	    phy->pdata->rx1tx1_mode_use_tx_num)
		return b9361_en_dis_tx(phy, TX_1 | TX_2,
...
int32_t b9361_bist_loopback(struct b9361_rf_phy *phy, int32_t mode)
{
	...
	reg = b9361_spi_read(phy->spi, REG_OBSERVE_CONFIG);

	phy->bist_loopback_mode = mode;

	switch (mode) {
	case 0:
		b9361_hdl_loopback(phy, false);
		b9361_int_loopback_fix_ch_cross(phy, false);
		reg &= ~(DATA_PORT_SP_HD_LOOP_TEST_OE |
			 DATA_PORT_LOOP_TEST_ENABLE);
		return b9361_spi_write(phy->spi, REG_OBSERVE_CONFIG, reg);
	case 1:
		/* loopback (B9361 internal) TX->RX */
		b9361_hdl_loopback(phy, false);
		b9361_int_loopback_fix_ch_cross(phy, true);
		sp_hd = b9361_spi_read(phy->spi, REG_PARALLEL_PORT_CONF_3);
...
int32_t b9361_bist_prbs(struct b9361_rf_phy *phy, enum b9361_bist_mode mode)
{
	...
	return b9361_spi_write(phy->spi, REG_BIST_CONFIG, reg);
}
			 ...
			 uint32_t level_dB, uint32_t mask)
{
	...
	b9361_spi_write(phy->spi, REG_BIST_AND_DATA_PORT_TEST_CONFIG, reg1);
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_check_cal_done(struct b9361_rf_phy *phy, uint32_t reg,
				     uint32_t mask, uint32_t done_state)
{
	...
	do {
		state = b9361_spi_readf(phy->spi, reg, mask);
		if (state == done_state)
			return 0;
...
/**
 * Run an B9361 calibration and check the calibration done bit.
 * @param phy The B9361 state structure.
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_run_calibration(struct b9361_rf_phy *phy, uint32_t mask)
{
	int32_t ret = b9361_spi_write(phy->spi, REG_CALIBRATION_CTRL, mask);
	if (ret < 0)
		return ret;

	dev_dbg(&phy->spi->dev, "%s: CAL Mask 0x%"PRIx32, __func__, mask);

	return b9361_check_cal_done(phy, REG_CALIBRATION_CTRL, mask, 0);
}
 ...
 */
static int32_t b9361_gt_tableindex(struct b9361_rf_phy *phy, uint64_t freq)
{
	int32_t i;
 ...
 */
static uint32_t b9361_gt(struct b9361_rf_phy *phy)
{
 ...
 */
static int find_table_index(struct b9361_rf_phy *phy, int gain)
{
	uint32_t i, nm1, n;

	for (i = 0; i < phy->gt_info[b9361_gt(phy)].max_index; i++) {
		if (phy->gt_info[b9361_gt(phy)].abs_gain_tbl[i] >= gain) {
			nm1 = abs(phy->gt_info[b9361_gt(phy)].abs_gain_tbl[
					  (i > 0) ? i - 1 : i] - gain);
			n = abs(phy->gt_info[b9361_gt(phy)].abs_gain_tbl[i]
				- gain);
			if (nm1 < n)
				return (i > 0) ? i - 1 : i;
			else
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_load_gt(struct b9361_rf_phy *phy, uint64_t freq,
			      uint32_t dest)
{
	...
	band = b9361_gt_tableindex(phy, freq);

	dev_dbg(&phy->spi->dev, "%s: frequency %"PRIu64" (band %ld)",
		__func__, freq, band);
	...
	b9361_spi_writef(spi, REG_AGC_CONFIG_2,
			  AGC_USE_FULL_GAIN_TABLE, !phy->pdata->split_gt);

	b9361_spi_write(spi, REG_MAX_LMT_FULL_GAIN,
			 index_max - 1); /* Max Full/LMT Gain Table Index */

	set_gain = b9361_spi_readf(spi, REG_RX1_MANUAL_LMT_FULL_GAIN,
	...
	set_gain = b9361_spi_readf(spi, REG_RX2_MANUAL_LMT_FULL_GAIN,
				    RX_FULL_TBL_IDX_MASK);
	...
	b9361_spi_write(spi, REG_GAIN_TABLE_CONFIG, START_GAIN_TABLE_CLOCK |
	...
	for (i = 0; i < index_max; i++) {
		b9361_spi_write(spi, REG_GAIN_TABLE_ADDRESS, i); /* Gain Table Index */
		b9361_spi_write(spi, REG_GAIN_TABLE_WRITE_DATA1,
				 tab[i][0] | lna); /* Ext LNA, Int LNA, & Mixer Gain Word */
		b9361_spi_write(spi, REG_GAIN_TABLE_WRITE_DATA2,
				 tab[i][1]); /* TIA & LPF Word */
		b9361_spi_write(spi, REG_GAIN_TABLE_WRITE_DATA3,
				 tab[i][2]); /* DC Cal bit & Dig Gain Word */
		b9361_spi_write(spi, REG_GAIN_TABLE_CONFIG,
				 START_GAIN_TABLE_CLOCK |
				 WRITE_GAIN_TABLE |
				 RECEIVER_SELECT(dest)); /* Gain Table Index */
		b9361_spi_write(spi, REG_GAIN_TABLE_READ_DATA1,
	...
	b9361_spi_write(spi, REG_GAIN_TABLE_READ_DATA1,
			 0); /* Dummy Write to delay ~1u */
	b9361_spi_write(spi, REG_GAIN_TABLE_CONFIG, 0); /* Stop Gain Table Clock */
	...
	b9361_spi_writef(spi, REG_RX1_MANUAL_LMT_FULL_GAIN,
	...
	b9361_spi_write(spi, REG_RX2_MANUAL_LMT_FULL_GAIN,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_setup_ext_lna(struct b9361_rf_phy *phy,
				    struct elna_control *ctrl)
{
	b9361_spi_writef(phy->spi, REG_EXTERNAL_LNA_CTRL, EXTERNAL_LNA1_CTRL,
			  ctrl->elna_1_control_en);

	b9361_spi_writef(phy->spi, REG_EXTERNAL_LNA_CTRL, EXTERNAL_LNA2_CTRL,
			  ctrl->elna_2_control_en);

	b9361_spi_write(phy->spi, REG_EXT_LNA_HIGH_GAIN,
			 EXT_LNA_HIGH_GAIN(ctrl->gain_mdB / 500));

	return b9361_spi_write(phy->spi, REG_EXT_LNA_LOW_GAIN,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_clkout_control(struct b9361_rf_phy *phy,
				     enum b9361_clkout mode)
{
	if (mode == CLKOUT_DISABLE)
		return b9361_spi_writef(phy->spi, REG_BBPLL, CLKOUT_ENABLE, 0);

	return b9361_spi_writef(phy->spi, REG_BBPLL,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_load_mixer_gm_subtable(struct b9361_rf_phy *phy)
{
	int32_t i, addr;
	dev_dbg(&phy->spi->dev, "%s", __func__);

	b9361_spi_write(phy->spi, REG_GM_SUB_TABLE_CONFIG,
			 START_GM_SUB_TABLE_CLOCK); /* Start Clock */

	for (i = 0, addr = ARRAY_SIZE(gm_st_ctrl); i < (int64_t)ARRAY_SIZE(gm_st_ctrl);
	     i++) {
		b9361_spi_write(phy->spi, REG_GM_SUB_TABLE_ADDRESS,
				 --addr); /* Gain Table Index */
		b9361_spi_write(phy->spi, REG_GM_SUB_TABLE_BIAS_WRITE, 0); /* Bias */
		b9361_spi_write(phy->spi, REG_GM_SUB_TABLE_GAIN_WRITE,
				 gm_st_gain[i]); /* Gain */
		b9361_spi_write(phy->spi, REG_GM_SUB_TABLE_CTRL_WRITE,
				 gm_st_ctrl[i]); /* Control */
		b9361_spi_write(phy->spi, REG_GM_SUB_TABLE_CONFIG,
				 WRITE_GM_SUB_TABLE | START_GM_SUB_TABLE_CLOCK); /* Write Words */
		b9361_spi_write(phy->spi, REG_GM_SUB_TABLE_GAIN_READ, 0); /* Dummy Delay */
		b9361_spi_write(phy->spi, REG_GM_SUB_TABLE_GAIN_READ, 0); /* Dummy Delay */
	}
	...
	b9361_spi_write(phy->spi, REG_GM_SUB_TABLE_GAIN_READ, 0); /* Dummy Delay */
	b9361_spi_write(phy->spi, REG_GM_SUB_TABLE_GAIN_READ, 0); /* Dummy Delay */
	b9361_spi_write(phy->spi, REG_GM_SUB_TABLE_CONFIG, 0); /* Stop Clock */
			    ...
			    bool tx1, bool tx2, bool immed)
{
	...
	b9361_spi_writef(phy->spi, REG_TX2_DIG_ATTEN,
			  IMMEDIATELY_UPDATE_TPC_ATTEN, 0);

	if (tx1)
		ret = b9361_spi_writem(phy->spi, REG_TX1_ATTEN_1, buf, 2);

	if (tx2)
		ret = b9361_spi_writem(phy->spi, REG_TX2_ATTEN_1, buf, 2);
...
int32_t b9361_get_tx_atten(struct b9361_rf_phy *phy, uint32_t tx_num)
{
	...
	ret = b9361_spi_readm(phy->spi, (tx_num == 1) ?
...
int32_t b9361_tx_mute(struct b9361_rf_phy *phy, uint32_t state)
{
	...
	if (state) {
		phy->tx1_atten_cached = b9361_get_tx_atten(phy, 1);
		phy->tx2_atten_cached = b9361_get_tx_atten(phy, 2);

		return b9361_set_tx_atten(phy, 89750, true, true, true);
	} else {
		if (phy->tx1_atten_cached == phy->tx2_atten_cached)
			return b9361_set_tx_atten(phy, phy->tx1_atten_cached,
						   true, true, true);

		ret = b9361_set_tx_atten(phy, phy->tx1_atten_cached,
					  true, false, true);
		ret |= b9361_set_tx_atten(phy, phy->tx2_atten_cached,
					   false, true, true);
 ...
 */
static uint32_t b9361_rfvco_tableindex(uint32_t freq)
{
	if (freq < 50000000UL)
		return LUT_FTDD_40;
 ...
 * @return 0 in case of success
 */
static int32_t b9361_rfpll_vco_init(struct b9361_rf_phy *phy,
				     ...
				     uint32_t ref_clk)
{
	...
	range = b9361_rfvco_tableindex(ref_clk);
	...
	b9361_spi_write(spi, REG_RX_VCO_OUTPUT + offs,
			 VCO_OUTPUT_LEVEL(tab[i].VCO_Output_Level) |
			 PORB_VCO_LOGIC);
	b9361_spi_writef(spi, REG_RX_ALC_VARACTOR + offs,
			  VCO_VARACTOR(~0), tab[i].VCO_Varactor);
	b9361_spi_write(spi, REG_RX_VCO_BIAS_1 + offs,
			 VCO_BIAS_REF(tab[i].VCO_Bias_Ref) |
			 VCO_BIAS_TCF(tab[i].VCO_Bias_Tcf)); /* b9361 revision */

	b9361_spi_write(spi, REG_RX_FORCE_VCO_TUNE_1 + offs,
			 VCO_CAL_OFFSET(tab[i].VCO_Cal_Offset));
	b9361_spi_write(spi, REG_RX_VCO_VARACTOR_CTRL_1 + offs,
			 VCO_VARACTOR_REFERENCE(
				 tab[i].VCO_Varactor_Reference));

	b9361_spi_write(spi, REG_RX_VCO_CAL_REF + offs, VCO_CAL_REF_TCF(0));

	b9361_spi_write(spi, REG_RX_VCO_VARACTOR_CTRL_0 + offs,
			 VCO_VARACTOR_OFFSET(0) |
			 VCO_VARACTOR_REFERENCE_TCF(7));

	b9361_spi_writef(spi, REG_RX_CP_CURRENT + offs, CHARGE_PUMP_CURRENT(~0),
			  tab[i].Charge_Pump_Current);
	b9361_spi_write(spi, REG_RX_LOOP_FILTER_1 + offs,
			 LOOP_FILTER_C2(tab[i].LF_C2) |
			 LOOP_FILTER_C1(tab[i].LF_C1));
	b9361_spi_write(spi, REG_RX_LOOP_FILTER_2 + offs,
			 LOOP_FILTER_R1(tab[i].LF_R1) |
			 LOOP_FILTER_C3(tab[i].LF_C3));
	b9361_spi_write(spi, REG_RX_LOOP_FILTER_3 + offs,
 ...
 * @return 0 in case of success,
 */
static int32_t b9361_get_split_table_gain(struct b9361_rf_phy *phy,
		uint32_t idx_reg,
		struct rf_rx_gain *rx_gain)
{
	...
	rx_gain->fgt_lmt_index = b9361_spi_readf(spi, idx_reg,
				 FULL_TABLE_GAIN_INDEX(~0));
	tbl_addr = b9361_spi_read(spi, REG_GAIN_TABLE_ADDRESS);

	b9361_spi_write(spi, REG_GAIN_TABLE_ADDRESS, rx_gain->fgt_lmt_index);

	val = b9361_spi_read(spi, REG_GAIN_TABLE_READ_DATA1);
	rx_gain->lna_index = TO_LNA_GAIN(val);
	rx_gain->mixer_index = TO_MIXER_GM_GAIN(val);

	rx_gain->tia_index = b9361_spi_readf(spi, REG_GAIN_TABLE_READ_DATA2, TIA_GAIN);

	rx_gain->lmt_gain = lna_table[b9361_gt(phy)][rx_gain->lna_index] +
			    mixer_table[b9361_gt(phy)][rx_gain->mixer_index] +
			    tia_table[rx_gain->tia_index];

	b9361_spi_write(spi, REG_GAIN_TABLE_ADDRESS, tbl_addr);

	/* Read LPF Index */
	rx_gain->lpf_gain = b9361_spi_readf(spi, idx_reg + 1, LPF_GAIN_RX(~0));

	/* Read Digital Gain */
	rx_gain->digital_gain = b9361_spi_readf(spi, idx_reg + 2,
				DIGITAL_GAIN_RX(~0));
 ...
 * @return 0 in case of success
 */
static int32_t b9361_get_full_table_gain(struct b9361_rf_phy *phy,
		uint32_t idx_reg,
		struct rf_rx_gain *rx_gain)
{
	struct spi_device *spi = phy->spi;
	...
	rx_gain->fgt_lmt_index = val = b9361_spi_readf(spi, idx_reg,
				       FULL_TABLE_GAIN_INDEX(~0));
	/* Read Digital Gain */
	rx_gain->digital_gain = b9361_spi_readf(spi, idx_reg + 2,
				DIGITAL_GAIN_RX(~0));

	rx_gain->gain_db = phy->gt_info[b9361_gt(phy)].abs_gain_tbl[val];
			   ...
			   uint32_t rx_id, struct rf_rx_gain *rx_gain)
{
	...
	val = b9361_spi_readf(spi, REG_RX_ENABLE_FILTER_CTRL, rx_enable_mask);
	...
	val = b9361_spi_read(spi, REG_AGC_CONFIG_1);
	...
	if (val == RX_GAIN_CTL_AGC_FAST_ATK) {
		...
		*/
		val = b9361_spi_read(spi, REG_FAST_ATTACK_STATE);
	...
	if (has_split_gt && phy->pdata->split_gt)
		rc = b9361_get_split_table_gain(phy, idx_reg, rx_gain);
	else
		rc = b9361_get_full_table_gain(phy, idx_reg, rx_gain);
...
{
	return b9361_spi_readf(phy->spi, REG_STATE, ENSM_STATE(~0));
}
...
void b9361_ensm_force_state(struct b9361_rf_phy *phy, uint8_t ensm_state)
{
	...
	dev_ensm_state = b9361_spi_readf(spi, REG_STATE, ENSM_STATE(~0));
	...
	val = b9361_spi_read(spi, REG_ENSM_CONFIG_1);
	...
	*/
	...
	b9361_spi_write(spi, REG_ENSM_CONFIG_1, TO_ALERT | FORCE_ALERT_STATE);

	rc = b9361_spi_write(spi, REG_ENSM_CONFIG_1, val);
	if (rc) {
		dev_err(dev, "Failed to write ENSM_CONFIG_1\n");
		goto out;
	}

	while (b9361_ensm_get_state(phy) != ensm_state && --timeout) {
		mdelay(1);
	}
...
{
	return b9361_ensm_restore_state(phy, phy->prev_ensm_state);
}
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t set_split_table_gain(struct b9361_rf_phy *phy, uint32_t idx_reg,
				    struct rf_rx_gain *rx_gain)
{
	struct spi_device *spi = phy->spi;
	int32_t rc = 0;
	...
	if (rc < 0) {
		dev_err(dev, "Invalid gain %ld, supported range [%d - %d]\n",
			rx_gain->gain_db, phy->gt_info[b9361_gt(phy)].
			abs_gain_tbl[0],
			phy->gt_info[b9361_gt(phy)].abs_gain_tbl
			[phy->gt_info[b9361_gt(phy)].max_index - 1]);
		goto out;
	}

	rx_gain->fgt_lmt_index = rc;

	b9361_spi_writef(spi, idx_reg, RX_FULL_TBL_IDX_MASK, rx_gain->fgt_lmt_index);
	b9361_spi_writef(spi, idx_reg + 1, RX_LPF_IDX_MASK, rx_gain->lpf_gain);

	if (phy->pdata->gain_ctrl.dig_gain_en) {
		b9361_spi_writef(spi, idx_reg + 2, RX_DIGITAL_IDX_MASK, rx_gain->digital_gain);
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t set_full_table_gain(struct b9361_rf_phy *phy, uint32_t idx_reg,
				   struct rf_rx_gain *rx_gain)
{
	struct spi_device *spi = phy->spi;
	int rc = 0;
	...
	rc = b9361_spi_writef(spi, idx_reg, RX_FULL_TBL_IDX_MASK, rc);
out:
	return rc;
}
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_gc_update(struct b9361_rf_phy *phy)
{
	struct spi_device *spi = phy->spi;
	uint32_t clkrf;
	...
	ret = b9361_spi_writef(spi, REG_AGC_ATTACK_DELAY,
	...
	reg = clamp_t(uint8_t, reg, 0U, 31U);
	ret |= b9361_spi_writef(spi, REG_PEAK_WAIT_TIME,
	...
	ret |= b9361_spi_writef(spi, REG_FAST_CONFIG_2_SETTLING_DELAY,
	...
	b9361_spi_writef(spi, REG_DEC_POWER_MEASURE_DURATION_0,
			  DEC_POWER_MEASUREMENT_DURATION(~0),
			  ilog2(dec_pow_meas_dur / 16));


	ret |= b9361_spi_writef(spi, REG_DIGITAL_SAT_COUNTER,
				 DOUBLE_GAIN_COUNTER,  reg > 65535);

	if (reg > 65535)
		reg /= 2;

	ret |= b9361_spi_write(spi, REG_GAIN_UPDATE_COUNTER1, reg & 0xFF);
	ret |= b9361_spi_write(spi, REG_GAIN_UPDATE_COUNTER2, reg >> 8);
	...
	ret |= b9361_spi_writef(spi, REG_FAST_ENERGY_DETECT_COUNT,
				  ...
				  struct rf_gain_ctrl *gain_ctrl)
{
	...
	rc = b9361_spi_readm(spi, REG_AGC_CONFIG_1, &val, 1);
	if (rc) {
	...
	rc = b9361_en_dis_rx(phy, gain_ctrl->ant, RX_DISABLE);
	if (rc) {
	...
	rc = b9361_spi_write(spi, REG_AGC_CONFIG_1, val);
	if (rc) {
	...
	b9361_en_dis_rx(phy, gain_ctrl->ant, RX_ENABLE);
	rc = b9361_gc_update(phy);
out:
	return rc;
}
...
int32_t b9361_read_rssi(struct b9361_rf_phy *phy, struct rf_rssi *rssi)
{
	...
	rc = b9361_spi_readm(spi, REG_PREAMBLE_LSB,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_rx_adc_setup(struct b9361_rf_phy *phy,
				   uint32_t bbpll_freq,
				   uint32_t adc_sampl_freq_Hz)
{
	...
	uint8_t c3_msb = b9361_spi_read(phy->spi, REG_RX_BBF_C3_MSB);
	uint8_t c3_lsb = b9361_spi_read(phy->spi, REG_RX_BBF_C3_LSB);
	uint8_t r2346 = b9361_spi_read(phy->spi, REG_RX_BBF_R2346);

	/*
	* BBBW = (BBPLL / RxTuneDiv) * ln(2) / (1.4 * 2PI )
	* We assume b9361_rx_bb_analog_filter_calib() is always run prior
	*/
	...
	for (i = 0; i < 40; i++) {
		ret = b9361_spi_write(phy->spi, 0x200 + i, data[i]);
		if (ret < 0)
			return ret;
	}
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_rx_tia_calib(struct b9361_rf_phy *phy, uint32_t bb_bw_Hz)
{
	uint32_t Cbbf, R2346;
	uint64_t CTIA_fF;

	uint8_t reg1EB = b9361_spi_read(phy->spi, REG_RX_BBF_C3_MSB);
	uint8_t reg1EC = b9361_spi_read(phy->spi, REG_RX_BBF_C3_LSB);
	uint8_t reg1E6 = b9361_spi_read(phy->spi, REG_RX_BBF_R2346);
	...
	b9361_spi_write(phy->spi, REG_RX_TIA_CONFIG, reg1DB);
	b9361_spi_write(phy->spi, REG_TIA1_C_LSB, reg1DC);
	b9361_spi_write(phy->spi, REG_TIA1_C_MSB, reg1DD);
	b9361_spi_write(phy->spi, REG_TIA2_C_LSB, reg1DE);
	b9361_spi_write(phy->spi, REG_TIA2_C_MSB, reg1DF);
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_rx_bb_analog_filter_calib(struct b9361_rf_phy *phy,
		uint32_t rx_bb_bw,
		uint32_t bbpll_freq)
{
	uint32_t target;
	...
	b9361_spi_write(phy->spi, REG_RX_BBF_TUNE_DIVIDE, phy->rxbbf_div);
	b9361_spi_writef(phy->spi, REG_RX_BBF_TUNE_CONFIG, BIT(0),
			  phy->rxbbf_div >> 8);

	/* Write the BBBW into registers 0x1FB and 0x1FC */
	b9361_spi_write(phy->spi, REG_RX_BBBW_MHZ, rx_bb_bw / 1000000UL);

	tmp = DIV_ROUND_CLOSEST((rx_bb_bw % 1000000UL) * 128, 1000000UL);
	b9361_spi_write(phy->spi, REG_RX_BBBW_KHZ, min_t(uint8_t, 127, tmp));

	b9361_spi_write(phy->spi, REG_RX_MIX_LO_CM,
			 RX_MIX_LO_CM(0x3F)); /* Set Rx Mix LO CM */
	b9361_spi_write(phy->spi, REG_RX_MIX_GM_CONFIG,
			 RX_MIX_GM_PLOAD(3)); /* Set GM common mode */

	/* Enable the RX BBF tune circuit by writing 0x1E2=0x02 and 0x1E3=0x02 */
	b9361_spi_write(phy->spi, REG_RX1_TUNE_CTRL, RX1_TUNE_RESAMPLE);
	b9361_spi_write(phy->spi, REG_RX2_TUNE_CTRL, RX2_TUNE_RESAMPLE);

	/* Start the RX Baseband Filter calibration in register 0x016[7] */
	/* Calibration is complete when register 0x016[7] self clears */
	ret = b9361_run_calibration(phy, RX_BB_TUNE_CAL);

	/* Disable the RX baseband filter tune circuit, write 0x1E2=3, 0x1E3=3 */
	b9361_spi_write(phy->spi, REG_RX1_TUNE_CTRL,
			 RX1_TUNE_RESAMPLE | RX1_PD_TUNE);
	b9361_spi_write(phy->spi, REG_RX2_TUNE_CTRL,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_tx_bb_analog_filter_calib(struct b9361_rf_phy *phy,
		uint32_t tx_bb_bw,
		uint32_t bbpll_freq)
{
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_tx_bb_second_filter_calib(struct b9361_rf_phy *phy,
		uint32_t tx_bb_bw)
{
	uint64_t cap;
	...
	ret = b9361_spi_write(phy->spi, REG_CONFIG0, reg_conf);
	ret |= b9361_spi_write(phy->spi, REG_RESISTOR, reg_res);
	ret |= b9361_spi_write(phy->spi, REG_CAPACITOR, (uint8_t)cap);
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_txrx_synth_cp_calib(struct b9361_rf_phy *phy,
		uint32_t ref_clk_hz, bool tx)
{
	...
	/* REVIST: */
	b9361_spi_write(phy->spi, REG_RX_CP_LEVEL_DETECT + offs, 0x17);

	b9361_spi_write(phy->spi, REG_RX_DSM_SETUP_1 + offs, 0x0);

	b9361_spi_write(phy->spi, REG_RX_LO_GEN_POWER_MODE + offs, 0x00);
	b9361_spi_write(phy->spi, REG_RX_VCO_LDO + offs, 0x0B);
	b9361_spi_write(phy->spi, REG_RX_VCO_PD_OVERRIDES + offs, 0x02);
	b9361_spi_write(phy->spi, REG_RX_CP_CURRENT + offs, 0x80);
	b9361_spi_write(phy->spi, REG_RX_CP_CONFIG + offs, CP_OFFSET_OFF);
	...
	b9361_spi_write(phy->spi, REG_RX_VCO_CAL + offs, vco_cal_cnt);

	/* Enable FDD mode during calibrations */

	if (!phy->pdata->fdd) {
		b9361_spi_writef(phy->spi, REG_PARALLEL_PORT_CONF_3,
				  HALF_DUPLEX_MODE, 0);
	}

	b9361_spi_write(phy->spi, REG_ENSM_CONFIG_2, DUAL_SYNTH_MODE);
	b9361_spi_write(phy->spi, REG_ENSM_CONFIG_1,
			 FORCE_ALERT_STATE |
			 TO_ALERT);
	b9361_spi_write(phy->spi, REG_ENSM_MODE, FDD_MODE);

	b9361_spi_write(phy->spi, REG_RX_CP_CONFIG + offs,
			 CP_OFFSET_OFF | CP_CAL_ENABLE);

	return b9361_check_cal_done(phy, REG_RX_CAL_STATUS + offs,
				     CP_CAL_VALID, 1);
}
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_bb_dc_offset_calib(struct b9361_rf_phy *phy)
{
	dev_dbg(&phy->spi->dev, "%s", __func__);

	b9361_spi_write(phy->spi, REG_BB_DC_OFFSET_COUNT, 0x3F);
	b9361_spi_write(phy->spi, REG_BB_DC_OFFSET_SHIFT, BB_DC_M_SHIFT(0xF));
	b9361_spi_write(phy->spi, REG_BB_DC_OFFSET_ATTEN, BB_DC_OFFSET_ATTEN(1));

	return b9361_run_calibration(phy, BBDC_CAL);
}
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_rf_dc_offset_calib(struct b9361_rf_phy *phy,
		uint64_t rx_freq)
{
	struct spi_device *spi = phy->spi;
	...
	b9361_spi_write(spi, REG_WAIT_COUNT, 0x20);

	if (rx_freq <= 4000000000ULL) {
		b9361_spi_write(spi, REG_RF_DC_OFFSET_COUNT,
				 phy->pdata->rf_dc_offset_count_low);
		b9361_spi_write(spi, REG_RF_DC_OFFSET_CONFIG_1,
				 RF_DC_CALIBRATION_COUNT(4) | DAC_FS(2));
		b9361_spi_write(spi, REG_RF_DC_OFFSET_ATTEN,
				 RF_DC_OFFSET_ATTEN(
	...
	return b9361_run_calibration(phy, RFDC_CAL);
}
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t __b9361_update_rf_bandwidth(struct b9361_rf_phy *phy,
		uint32_t rf_rx_bw, uint32_t rf_tx_bw)
{
	...
	ret = b9361_rx_bb_analog_filter_calib(phy,
					       real_rx_bandwidth,
					       bbpll_freq);
	if (ret < 0)
		return ret;

	ret = b9361_tx_bb_analog_filter_calib(phy,
					       real_tx_bandwidth,
					       bbpll_freq);
	if (ret < 0)
		return ret;

	ret = b9361_rx_tia_calib(phy, real_rx_bandwidth);
	if (ret < 0)
		return ret;

	ret = b9361_tx_bb_second_filter_calib(phy, real_tx_bandwidth);
	if (ret < 0)
		return ret;

	ret = b9361_rx_adc_setup(phy,
				  bbpll_freq,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t __b9361_tx_quad_calib(struct b9361_rf_phy *phy, uint32_t phase,
				      uint32_t rxnco_word, uint32_t decim, uint8_t *res)
{
	int32_t ret;

	b9361_spi_write(phy->spi, REG_QUAD_CAL_NCO_FREQ_PHASE_OFFSET,
			 RX_NCO_FREQ(rxnco_word) | RX_NCO_PHASE_OFFSET(phase));
	b9361_spi_write(phy->spi, REG_QUAD_CAL_CTRL,
	...
	ret =  b9361_run_calibration(phy, TX_QUAD_CAL);
	if (ret < 0)
		return ret;

	if (res)
		*res = b9361_spi_read(phy->spi,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_tx_quad_phase_search(struct b9361_rf_phy *phy,
		uint32_t rxnco_word, uint8_t decim)
{
	...
	for (i = 0; i < (int64_t)(ARRAY_SIZE(field) / 2); i++) {
		ret =  __b9361_tx_quad_calib(phy, i, rxnco_word, decim, &val);
		if (ret < 0)
			return ret;
	...
	ret = b9361_find_opt(field, ARRAY_SIZE(field), &start);
	...
	ret = __b9361_tx_quad_calib(phy, phy->last_tx_quad_cal_phase, rxnco_word,
				     decim, NULL);
	if (ret < 0)
		return ret;
...
static int b9361_tx_quad_calib(struct b9361_rf_phy *phy,
				...
				int32_t rx_phase)
{
	...
	if (phy->cached_synth_pd[0] & TX_LO_POWER_DOWN) {
		if (phy->pdata->lo_powerdown_managed_en) {
			b9361_spi_writef(spi, REG_TX_SYNTH_POWER_DOWN_OVERRIDE,
					  TX_LO_POWER_DOWN, 0);
		} else {
			dev_err(dev,
	...
	*/
	...
	if (txnco_freq > (int64_t)(bw_rx / 4) || txnco_freq > (int64_t)(bw_tx / 4)) {
		...
		ret = __b9361_update_rf_bandwidth(phy, txnco_freq * 8, txnco_freq * 8);
		if (ret < 0)
			goto out_restore;
	}
	...
	if (phase_inversion_en) {
		b9361_spi_writef(spi, REG_PARALLEL_PORT_CONF_2, INVERT_RX2, 0);

		reg_inv_bits = b9361_spi_read(spi, REG_INVERT_BITS);
	...
	b9361_spi_writef(spi, REG_KEXP_2, TX_NCO_FREQ(~0), txnco_word);
	b9361_spi_write(spi, REG_QUAD_CAL_COUNT, 0xFF);
	b9361_spi_write(spi, REG_KEXP_1, KEXP_TX(1) | KEXP_TX_COMP(3) |
			 KEXP_DC_I(3) | KEXP_DC_Q(3));
	b9361_spi_write(spi, REG_MAG_FTEST_THRESH, 0x01);
	b9361_spi_write(spi, REG_MAG_FTEST_THRESH_2, 0x01);

	if (phy->tx_quad_lpf_tia_match < 0) /* set in b9361_load_gt() */
		dev_err(dev, "failed to find suitable LPF TIA value in gain table\n");
	else
		b9361_spi_write(spi, REG_TX_QUAD_FULL_LMT_GAIN,
				 phy->tx_quad_lpf_tia_match);

	b9361_spi_write(spi, REG_QUAD_SETTLE_COUNT, 0xF0);
	b9361_spi_write(spi, REG_TX_QUAD_LPF_GAIN, 0x00);

	if (rx_phase != -2) {
		ret = __b9361_tx_quad_calib(phy, __rx_phase, rxnco_word, decim, &val);
		...
		if (val != (TX1_LO_CONV | TX1_SSB_CONV)) {
			if (phy->last_tx_quad_cal_phase < 31)
				ret = __b9361_tx_quad_calib(phy, phy->last_tx_quad_cal_phase,
	...
	if (val != (TX1_LO_CONV | TX1_SSB_CONV))
		ret = b9361_tx_quad_phase_search(phy, rxnco_word, decim);

	if (phase_inversion_en) {
		b9361_spi_writef(spi, REG_PARALLEL_PORT_CONF_2, INVERT_RX2, 1);
		b9361_spi_write(spi, REG_INVERT_BITS, reg_inv_bits);
	}

	if (txnco_freq > (int64_t)(bw_rx / 4) || txnco_freq > (int64_t)(bw_tx / 4)) {
		__b9361_update_rf_bandwidth(phy,
...
out_restore:
	...
	if (phy->pdata->lo_powerdown_managed_en &&
		...
		b9361_synth_lo_powerdown(phy, LO_DONTCARE, LO_DONTCARE);
				...
				bool rfdc_track, bool rxquad_track)
{
	...
	b9361_spi_write(spi, REG_CALIBRATION_CONFIG_2,
			 CALIBRATION_CONFIG2_DFLT | K_EXP_PHASE(0x15));
	b9361_spi_write(spi, REG_CALIBRATION_CONFIG_3,
	...
	b9361_spi_writef(spi, REG_RX_QUAD_GAIN2,
	...
	b9361_spi_write(spi, REG_CALIBRATION_CONFIG_1,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_trx_vco_cal_control(struct b9361_rf_phy *phy,
		bool tx, bool enable)
{
	dev_dbg(&phy->spi->dev, "%s : state %d",
		__func__, enable);

	return b9361_spi_writef(phy->spi,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_trx_ext_lo_control(struct b9361_rf_phy *phy,
		bool tx, bool enable)
{
	...
	bool mcs_rf_enable = b9361_spi_readf(phy->spi,
	...
	if (tx) {
		ret = b9361_spi_writef(phy->spi, REG_ENSM_CONFIG_2,
					POWER_DOWN_TX_SYNTH, mcs_rf_enable ? 0 : enable);

		ret |= b9361_spi_writef(phy->spi, REG_RFPLL_DIVIDERS,
		...
		ret |= b9361_spi_write(phy->spi, REG_TX_SYNTH_POWER_DOWN_OVERRIDE,
					phy->cached_synth_pd[0]);

		ret |= b9361_spi_writef(phy->spi, REG_ANALOG_POWER_DOWN_OVERRIDE,
					 TX_EXT_VCO_BUFFER_POWER_DOWN, !enable);

		ret |= b9361_spi_write(phy->spi, REG_TX_LO_GEN_POWER_MODE,
		...
		ret |= b9361_spi_write(phy->spi, REG_RX_SYNTH_POWER_DOWN_OVERRIDE,
					phy->cached_synth_pd[1]);

		ret |= b9361_spi_writef(phy->spi, REG_ANALOG_POWER_DOWN_OVERRIDE,
					 RX_EXT_VCO_BUFFER_POWER_DOWN, !enable);

		ret |= b9361_spi_write(phy->spi, REG_RX_LO_GEN_POWER_MODE,
			      ...
			      enum synth_pd_ctrl tx)
{
	...
	return b9361_spi_writem(phy->spi, REG_TX_SYNTH_POWER_DOWN_OVERRIDE,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_set_ref_clk_cycles(struct b9361_rf_phy *phy,
		uint32_t ref_clk_hz)
{
	dev_dbg(&phy->spi->dev, "%s : ref_clk_hz %"PRIu32,
		__func__, ref_clk_hz);

	return b9361_spi_write(phy->spi, REG_REFERENCE_CLOCK_CYCLES,
			     ...
			     uint32_t coarse, uint32_t fine)
{
	...
	b9361_spi_write(phy->spi, REG_DCXO_COARSE_TUNE,
			 DCXO_TUNE_COARSE(coarse));
	b9361_spi_write(phy->spi, REG_DCXO_FINE_TUNE_LOW,
			 DCXO_TUNE_FINE_LOW(fine));
	return b9361_spi_write(phy->spi, REG_DCXO_FINE_TUNE_HIGH,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_txmon_setup(struct b9361_rf_phy *phy,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_txmon_control(struct b9361_rf_phy *phy,
				    int32_t en_mask)
{
	...
	if (!phy->pdata->fdd && en_mask) {
		b9361_spi_writef(phy->spi, REG_ENSM_CONFIG_1,
	...
	b9361_spi_writef(phy->spi, REG_ANALOG_POWER_DOWN_OVERRIDE,
			  TX_MONITOR_POWER_DOWN(~0), ~en_mask);

	b9361_spi_writef(phy->spi, REG_TPM_MODE_ENABLE,
			  TX1_MON_ENABLE, !!(en_mask & TX_1));

	return b9361_spi_writef(phy->spi, REG_TPM_MODE_ENABLE,
			     ...
			     uint32_t rx_inputs, uint32_t txb)
{
	...
	if (!is_out) {
		if (rx_inputs > 8)
			return b9361_txmon_control(phy, rx_inputs & (TX_1 | TX_2));
		else
			b9361_txmon_control(phy, 0);
	}
	...
	return b9361_spi_write(phy->spi, REG_INPUT_SELECT, val);
}
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_pp_port_setup(struct b9361_rf_phy *phy, bool restore_c3)
{
	struct spi_device *spi = phy->spi;
	struct b9361_phy_platform_data *pd = phy->pdata;

	dev_dbg(&phy->spi->dev, "%s", __func__);

	if (restore_c3) {
		return b9361_spi_write(spi, REG_PARALLEL_PORT_CONF_3,
	...
	b9361_spi_write(spi, REG_PARALLEL_PORT_CONF_1, pd->port_ctrl.pp_conf[0]);
	b9361_spi_write(spi, REG_PARALLEL_PORT_CONF_2, pd->port_ctrl.pp_conf[1]);
	b9361_spi_write(spi, REG_PARALLEL_PORT_CONF_3, pd->port_ctrl.pp_conf[2]);
	b9361_spi_write(spi, REG_RX_CLOCK_DATA_DELAY, pd->port_ctrl.rx_clk_data_delay);
	b9361_spi_write(spi, REG_TX_CLOCK_DATA_DELAY, pd->port_ctrl.tx_clk_data_delay);

	b9361_spi_write(spi, REG_LVDS_BIAS_CTRL, pd->port_ctrl.lvds_bias_ctrl);
	//	b9361_spi_write(spi, REG_DIGITAL_IO_CTRL, pd->port_ctrl.digital_io_ctrl);
	b9361_spi_write(spi, REG_LVDS_INVERT_CTRL1, pd->port_ctrl.lvds_invert[0]);
	b9361_spi_write(spi, REG_LVDS_INVERT_CTRL2, pd->port_ctrl.lvds_invert[1]);

	if (pd->rx1rx2_phase_inversion_en ||
	    (pd->port_ctrl.pp_conf[1] & INVERT_RX2)) {

		b9361_spi_writef(spi, REG_PARALLEL_PORT_CONF_2, INVERT_RX2, 1);
		b9361_spi_writef(spi, REG_INVERT_BITS,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_gc_setup(struct b9361_rf_phy *phy,
			       struct gain_control *ctrl)
{
	...
	b9361_spi_write(spi, REG_AGC_CONFIG_1, reg); // Gain Control Mode Select

	/* AGC_USE_FULL_GAIN_TABLE handled in b9361_load_gt() */
	b9361_spi_writef(spi, REG_AGC_CONFIG_2, MAN_GAIN_CTRL_RX1,
			  ctrl->mgc_rx1_ctrl_inp_en);
	b9361_spi_writef(spi, REG_AGC_CONFIG_2, MAN_GAIN_CTRL_RX2,
			  ctrl->mgc_rx2_ctrl_inp_en);
	b9361_spi_writef(spi, REG_AGC_CONFIG_2, DIG_GAIN_EN,
			  ctrl->dig_gain_en);
	...
	b9361_spi_write(spi, REG_AGC_CONFIG_3,
	...
	b9361_spi_write(spi, REG_RX1_MANUAL_LMT_FULL_GAIN,
	...
	b9361_spi_write(spi, REG_PEAK_WAIT_TIME,
			 reg); // Decr Step Size, Peak Overload Time

	if (ctrl->dig_gain_en)
		b9361_spi_write(spi, REG_DIGITAL_GAIN,
	...
	if (ctrl->adc_large_overload_thresh >= ctrl->adc_small_overload_thresh) {
		b9361_spi_write(spi, REG_ADC_SMALL_OVERLOAD_THRESH,
				 ctrl->adc_small_overload_thresh); // ADC Small Overload Threshold
		b9361_spi_write(spi, REG_ADC_LARGE_OVERLOAD_THRESH,
	...
	b9361_spi_write(spi, REG_LARGE_LMT_OVERLOAD_THRESH, reg);
	reg = (ctrl->lmt_overload_low_thresh / 16) - 1;
	reg = clamp(reg, 0U, 63U);
	b9361_spi_writef(spi, REG_SMALL_LMT_OVERLOAD_THRESH,
			  SMALL_LMT_OVERLOAD_THRESH(~0), reg);

	if (has_split_gt && phy->pdata->split_gt) {
		/* REVIST */
		b9361_spi_write(spi, REG_RX1_MANUAL_LPF_GAIN, 0x58); // Rx1 LPF Gain Index
		b9361_spi_write(spi, REG_RX2_MANUAL_LPF_GAIN, 0x18); // Rx2 LPF Gain Index
		b9361_spi_write(spi, REG_FAST_INITIAL_LMT_GAIN_LIMIT,
				 0x27); // Initial LMT Gain Limit
	}

	b9361_spi_write(spi, REG_RX1_MANUAL_DIGITALFORCED_GAIN,
			 0x00); // Rx1 Digital Gain Index
	b9361_spi_write(spi, REG_RX2_MANUAL_DIGITALFORCED_GAIN,
			 0x00); // Rx2 Digital Gain Index

	reg = clamp_t(uint8_t, ctrl->low_power_thresh, 0U, 64U) * 2;
	b9361_spi_write(spi, REG_FAST_LOW_POWER_THRESH, reg); // Low Power Threshold
	b9361_spi_write(spi, REG_TX_SYMBOL_ATTEN_CONFIG,
	...
	b9361_spi_writef(spi, REG_AGC_LOCK_LEVEL,
	...
	b9361_spi_write(spi, REG_GAIN_STP_2, reg);
	...
	b9361_spi_write(spi, REG_GAIN_STP1, reg);
	...
	b9361_spi_write(spi, REG_ADC_OVERLOAD_COUNTERS, reg);

	b9361_spi_writef(spi, REG_GAIN_STP_CONFIG_2, LARGE_LPF_GAIN_STEP(~0),
	...
	b9361_spi_write(spi, REG_LMT_OVERLOAD_COUNTERS, reg);

	b9361_spi_writef(spi, REG_GAIN_STP_CONFIG1,
	...
	b9361_spi_write(spi, REG_DIGITAL_SAT_COUNTER, reg);
	...
	*/
	...
	b9361_spi_writef(spi, REG_FAST_STRONG_SIGNAL_FREEZE,
	...
	reg = clamp_t(uint32_t, reg, 0U, 63U);
	b9361_spi_writef(spi, REG_FAST_GAIN_LOCK_EXIT_COUNT,
	...
	reg = !ctrl->f_agc_rst_gla_large_adc_overload_en;
	b9361_spi_writef(spi, REG_FAST_LOW_POWER_THRESH,
	...
	reg = clamp_t(uint32_t, reg, 0U, 15U);
	b9361_spi_writef(spi, REG_RX1_MANUAL_LPF_GAIN,
			  POWER_MEAS_IN_STATE_5(~0), reg);
	b9361_spi_writef(spi, REG_RX1_MANUAL_LMT_FULL_GAIN,
			  POWER_MEAS_IN_STATE_5_MSB, reg >> 3);

	return b9361_gc_update(phy);
}
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_auxdac_set(struct b9361_rf_phy *phy, int32_t dac,
				 int32_t val_mV)
{
	struct spi_device *spi = phy->spi;
	uint32_t val, tmp;
	...
	b9361_spi_writef(spi, REG_AUXDAC_ENABLE_CTRL,
	...
	switch (dac) {
	case 1:
		b9361_spi_write(spi, REG_AUXDAC_1_WORD, val >> 2);
		b9361_spi_write(spi, REG_AUXDAC_1_CONFIG, AUXDAC_1_WORD_LSB(val) | tmp);
		phy->auxdac1_value = val_mV;
		break;
	case 2:
		b9361_spi_write(spi, REG_AUXDAC_2_WORD, val >> 2);
		b9361_spi_write(spi, REG_AUXDAC_2_CONFIG, AUXDAC_2_WORD_LSB(val) | tmp);
 ...
 */
int32_t b9361_auxdac_get(struct b9361_rf_phy *phy, int32_t dac)
{
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_auxdac_setup(struct b9361_rf_phy *phy,
				   struct auxdac_control *ctrl)
{
	...
	b9361_auxdac_set(phy, 1, ctrl->dac1_default_value);
	b9361_auxdac_set(phy, 2, ctrl->dac2_default_value);
	...
	b9361_spi_writef(spi, REG_EXTERNAL_LNA_CTRL,
			  AUXDAC_MANUAL_SELECT, ctrl->auxdac_manual_mode_en);
	b9361_spi_write(spi, REG_AUXDAC1_RX_DELAY, ctrl->dac1_rx_delay_us);
	b9361_spi_write(spi, REG_AUXDAC1_TX_DELAY, ctrl->dac1_tx_delay_us);
	b9361_spi_write(spi, REG_AUXDAC2_RX_DELAY, ctrl->dac2_rx_delay_us);
	b9361_spi_write(spi, REG_AUXDAC2_TX_DELAY, ctrl->dac2_tx_delay_us);
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_auxadc_setup(struct b9361_rf_phy *phy,
				   ...
				   uint32_t bbpll_freq)
{
	...
	b9361_spi_write(spi, REG_TEMP_OFFSET, ctrl->offset);
	b9361_spi_write(spi, REG_START_TEMP_READING, 0x00);
	b9361_spi_write(spi, REG_TEMP_SENSE2,
			 MEASUREMENT_TIME_INTERVAL(val) |
			 (ctrl->periodic_temp_measuremnt ?
			  TEMP_SENSE_PERIODIC_ENABLE : 0));
	b9361_spi_write(spi, REG_TEMP_SENSOR_CONFIG,
			 TEMP_SENSOR_DECIMATION(
				 ilog2(ctrl->temp_sensor_decimation) - 8));
	b9361_spi_write(spi, REG_AUXADC_CLOCK_DIVIDER,
			 bbpll_freq / ctrl->auxadc_clock_rate);
	b9361_spi_write(spi, REG_AUXADC_CONFIG,
			 AUX_ADC_DECIMATION(
...
int32_t b9361_get_temp(struct b9361_rf_phy *phy)
{
	...
	b9361_spi_writef(phy->spi, REG_AUXADC_CONFIG, AUXADC_POWER_DOWN, 1);
	val = b9361_spi_read(phy->spi, REG_TEMPERATURE);
	b9361_spi_writef(phy->spi, REG_AUXADC_CONFIG, AUXADC_POWER_DOWN, 0);
 ...
 * @return The value in case of success, negative error code otherwise.
 */
int32_t b9361_get_auxadc(struct b9361_rf_phy *phy)
{
	uint8_t buf[2];

	b9361_spi_writef(phy->spi, REG_AUXADC_CONFIG, AUXADC_POWER_DOWN, 1);
	b9361_spi_readm(phy->spi, REG_AUXADC_LSB, buf, 2);
	b9361_spi_writef(phy->spi, REG_AUXADC_CONFIG, AUXADC_POWER_DOWN, 0);
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_ctrl_outs_setup(struct b9361_rf_phy *phy,
				      struct ctrl_outs_control *ctrl)
{
	...
	b9361_spi_write(spi, REG_CTRL_OUTPUT_POINTER, ctrl->index); // Ctrl Out index
	return b9361_spi_write(spi, REG_CTRL_OUTPUT_ENABLE,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_gpo_setup(struct b9361_rf_phy *phy,
				struct gpo_control *ctrl)
{
	...
	b9361_spi_write(spi, REG_AUTO_GPO,
	...
	b9361_spi_write(spi, REG_GPO_FORCE_AND_INIT,
	...
	b9361_spi_write(spi, REG_GPO0_RX_DELAY, ctrl->gpo0_rx_delay_us);
	b9361_spi_write(spi, REG_GPO0_TX_DELAY, ctrl->gpo0_tx_delay_us);
	b9361_spi_write(spi, REG_GPO1_RX_DELAY, ctrl->gpo1_rx_delay_us);
	b9361_spi_write(spi, REG_GPO1_TX_DELAY, ctrl->gpo1_tx_delay_us);
	b9361_spi_write(spi, REG_GPO2_RX_DELAY, ctrl->gpo2_rx_delay_us);
	b9361_spi_write(spi, REG_GPO2_TX_DELAY, ctrl->gpo2_tx_delay_us);
	b9361_spi_write(spi, REG_GPO3_RX_DELAY, ctrl->gpo3_rx_delay_us);
	b9361_spi_write(spi, REG_GPO3_TX_DELAY, ctrl->gpo3_tx_delay_us);
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_rssi_setup(struct b9361_rf_phy *phy,
				 ...
				 bool is_update)
{
	...
	b9361_spi_write(spi, REG_MEASURE_DURATION_01,
			 (dur_buf[1] << 4) | dur_buf[0]); // RSSI Measurement Duration 0, 1
	b9361_spi_write(spi, REG_MEASURE_DURATION_23,
			 (dur_buf[3] << 4) | dur_buf[2]); // RSSI Measurement Duration 2, 3
	b9361_spi_write(spi, REG_RSSI_WEIGHT_0,
			 weight[0]); // RSSI Weighted Multiplier 0
	b9361_spi_write(spi, REG_RSSI_WEIGHT_1,
			 weight[1]); // RSSI Weighted Multiplier 1
	b9361_spi_write(spi, REG_RSSI_WEIGHT_2,
			 weight[2]); // RSSI Weighted Multiplier 2
	b9361_spi_write(spi, REG_RSSI_WEIGHT_3,
			 weight[3]); // RSSI Weighted Multiplier 3
	b9361_spi_write(spi, REG_RSSI_DELAY, rssi_delay); // RSSI Delay
	b9361_spi_write(spi, REG_RSSI_WAIT_TIME, rssi_wait); // RSSI Wait
	...
	ret = b9361_spi_write(spi, REG_RSSI_CONFIG, temp); // RSSI Mode Select
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_bb_clk_change_handler(struct b9361_rf_phy *phy)
{
	int32_t ret;

	ret = b9361_gc_update(phy);
	ret |= b9361_rssi_setup(phy, &phy->pdata->rssi_ctrl, true);
	ret |= b9361_auxadc_setup(phy, &phy->pdata->auxadc_ctrl,
			      ...
			      bool pinctrl)
{
	...
	if (phy->curr_ensm_state == ENSM_STATE_SLEEP) {
		b9361_spi_write(spi, REG_CLOCK_ENABLE,
				 DIGITAL_POWER_UP | CLOCK_ENABLE_DFLT | BBPLL_ENABLE |
				 (phy->pdata->use_extclk ? XO_BYPASS : 0)); /* Enable Clocks */
		udelay(20);
		b9361_spi_write(spi, REG_ENSM_CONFIG_1, TO_ALERT | FORCE_ALERT_STATE);
		b9361_trx_vco_cal_control(phy, false, true); /* Enable VCO Cal */
		b9361_trx_vco_cal_control(phy, true, true);
	}
	...
	case ENSM_STATE_SLEEP:
		b9361_trx_vco_cal_control(phy, false, false); /* Disable VCO Cal */
		b9361_trx_vco_cal_control(phy, true, false);
		b9361_spi_write(spi, REG_ENSM_CONFIG_1, 0); /* Clear To Alert */
		b9361_spi_write(spi, REG_ENSM_CONFIG_1,
		...
		b9361_spi_write(spi, REG_ENSM_CONFIG_1, 0); /* Move to Wait*/
	...
	if (rc) {
		if ((phy->curr_ensm_state != ENSM_STATE_ALERT)
			...
			b9361_spi_write(spi, REG_ENSM_CONFIG_1, val2);

			b9361_check_cal_done(phy, REG_STATE, ENSM_STATE(~0), ENSM_STATE_ALERT);
		} else {
	...
	if (!phy->pdata->fdd && !pinctrl && !phy->pdata->tdd_use_dual_synth &&
		...
		b9361_spi_writef(phy->spi, REG_ENSM_CONFIG_2,
				  TXNRX_SPI_CTRL, ensm_state == ENSM_STATE_TX);

		b9361_check_cal_done(phy, (ensm_state == ENSM_STATE_TX) ?
	...
	if ((val & FORCE_RX_ON) &&
		...
		tmp = b9361_spi_read(spi, REG_SMALL_LMT_OVERLOAD_THRESH);
		b9361_spi_write(spi, REG_SMALL_LMT_OVERLOAD_THRESH,
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_validate_trx_clock_chain(struct b9361_rf_phy *phy,
				   ...
				   uint32_t *tx_path_clks)
{
	...
	ret = b9361_validate_trx_clock_chain(phy, rx_path_clks);
	if (ret < 0)
		return ret;
	...
	if (phy->rx_fir_dec == 1 || phy->bypass_rx_fir) {
		b9361_spi_writef(phy->spi, REG_RX_ENABLE_FILTER_CTRL,
				  RX_FIR_ENABLE_DECIMATION(~0), !phy->bypass_rx_fir);
	}

	if (phy->tx_fir_int == 1 || phy->bypass_tx_fir) {
		b9361_spi_writef(phy->spi, REG_TX_ENABLE_FILTER_CTRL,
	...
	if (!phy->pdata->dig_interface_tune_fir_disable &&
		...
		ret = b9361_dig_tune(phy, 0, SKIP_STORE_RESULT);

	return b9361_bb_clk_change_handler(phy);
}
					...
					uint32_t *tx_path_clks)
{
	...
	if ((index_tx < 0 || index_tx > 6 || index_rx < 0 || index_rx > 6)
		...
		return b9361_calculate_rf_clock_chain(phy, tx_sample_rate,
					...
					uint32_t freq)
{
	...
	ret = b9361_calculate_rf_clock_chain(phy, freq,
					      phy->rate_governor, rx, tx);
	if (ret < 0)
		return ret;
	return b9361_set_trx_clock_chain(phy, rx, tx);
}
...
int32_t b9361_set_ensm_mode(struct b9361_rf_phy *phy, bool fdd, bool pinctrl)
{
	...
	b9361_spi_write(phy->spi, REG_ENSM_MODE, fdd ? FDD_MODE : 0);

	val = b9361_spi_read(phy->spi, REG_ENSM_CONFIG_2);
	val &= POWER_DOWN_RX_SYNTH | POWER_DOWN_TX_SYNTH;

	if (fdd)
		ret = b9361_spi_write(phy->spi, REG_ENSM_CONFIG_2,
				       val | DUAL_SYNTH_MODE |
				       (pd->fdd_independent_mode ? FDD_EXTERNAL_CTRL_ENABLE : 0));
	else
		ret = b9361_spi_write(phy->spi, REG_ENSM_CONFIG_2, val |
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_fastlock_readval(struct spi_device *spi, bool tx,
				       uint32_t profile, uint32_t word)
{
	...
	b9361_spi_write(spi, REG_RX_FAST_LOCK_PROGRAM_ADDR + offs,
			 RX_FAST_LOCK_PROFILE_ADDR(profile) |
			 RX_FAST_LOCK_PROFILE_WORD(word));

	return b9361_spi_read(spi, REG_RX_FAST_LOCK_PROGRAM_READ + offs);
}
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_fastlock_writeval(struct spi_device *spi, bool tx,
					uint32_t profile, uint32_t word, uint8_t val, bool last)
{
	...
	ret = b9361_spi_write(spi, REG_RX_FAST_LOCK_PROGRAM_ADDR + offs,
			       RX_FAST_LOCK_PROFILE_ADDR(profile) |
			       RX_FAST_LOCK_PROFILE_WORD(word));
	ret |= b9361_spi_write(spi, REG_RX_FAST_LOCK_PROGRAM_DATA + offs, val);
	ret |= b9361_spi_write(spi, REG_RX_FAST_LOCK_PROGRAM_CTRL + offs,
				RX_FAST_LOCK_PROGRAM_WRITE |
				RX_FAST_LOCK_PROGRAM_CLOCK_ENABLE);

	if (last) /* Stop Clocks */
		ret |= b9361_spi_write(spi,
			     ...
			     uint32_t profile, uint8_t *values)
{
	...
	b9361_spi_writem(phy->spi, REG_RX_FAST_LOCK_PROGRAM_DATA + offs, buf, 2);
	...
	for (i = 1; i < RX_FAST_LOCK_CONFIG_WORD_NUM; i++) {
		...
		b9361_spi_writem(phy->spi, REG_RX_FAST_LOCK_PROGRAM_CTRL + offs, buf, 4);
	}

	b9361_spi_write(phy->spi, REG_RX_FAST_LOCK_PROGRAM_CTRL + offs,
			 RX_FAST_LOCK_PROGRAM_WRITE | RX_FAST_LOCK_PROGRAM_CLOCK_ENABLE);
	b9361_spi_write(phy->spi, REG_RX_FAST_LOCK_PROGRAM_CTRL + offs, 0);
			      ...
			      uint32_t profile)
{
	...
	val[0] = b9361_spi_read(spi, REG_RX_INTEGER_BYTE_0 + offs);
	val[1] = b9361_spi_read(spi, REG_RX_INTEGER_BYTE_1 + offs);
	val[2] = b9361_spi_read(spi, REG_RX_FRACT_BYTE_0 + offs);
	val[3] = b9361_spi_read(spi, REG_RX_FRACT_BYTE_1 + offs);
	val[4] = b9361_spi_read(spi, REG_RX_FRACT_BYTE_2 + offs);

	x = b9361_spi_readf(spi, REG_RX_VCO_BIAS_1 + offs, VCO_BIAS_REF(~0));
	y = b9361_spi_readf(spi, REG_RX_ALC_VARACTOR + offs, VCO_VARACTOR(~0));
	val[5] = (x << 4) | y;

	x = b9361_spi_readf(spi, REG_RX_VCO_BIAS_1 + offs, VCO_BIAS_TCF(~0));
	y = b9361_spi_readf(spi, REG_RX_CP_CURRENT + offs, CHARGE_PUMP_CURRENT(~0));
	/* Wide BW option: N = 1
	...
	*/
	...
	x = b9361_spi_readf(spi, REG_RX_LOOP_FILTER_3 + offs, LOOP_FILTER_R3(~0));
	val[8] = (x << 4) | x;

	x = b9361_spi_readf(spi, REG_RX_LOOP_FILTER_2 + offs, LOOP_FILTER_C3(~0));
	val[9] = (x << 4) | x;

	x = b9361_spi_readf(spi, REG_RX_LOOP_FILTER_1 + offs, LOOP_FILTER_C1(~0));
	y = b9361_spi_readf(spi, REG_RX_LOOP_FILTER_1 + offs, LOOP_FILTER_C2(~0));
	val[10] = (x << 4) | y;

	x = b9361_spi_readf(spi, REG_RX_LOOP_FILTER_2 + offs, LOOP_FILTER_R1(~0));
	val[11] = (x << 4) | x;

	x = b9361_spi_readf(spi, REG_RX_VCO_VARACTOR_CTRL_0 + offs,
			     VCO_VARACTOR_REFERENCE_TCF(~0));
	y = b9361_spi_readf(spi, REG_RFPLL_DIVIDERS,
			     tx ? TX_VCO_DIVIDER(~0) : RX_VCO_DIVIDER(~0));
	val[12] = (x << 4) | y;

	x = b9361_spi_readf(spi, REG_RX_FORCE_VCO_TUNE_1 + offs, VCO_CAL_OFFSET(~0));
	y = b9361_spi_readf(spi, REG_RX_VCO_VARACTOR_CTRL_1 + offs,
			     VCO_VARACTOR_REFERENCE(~0));
	val[13] = (x << 4) | y;

	val[14] = b9361_spi_read(spi, REG_RX_FORCE_VCO_TUNE_0 + offs);

	x = b9361_spi_readf(spi, REG_RX_FORCE_ALC + offs, FORCE_ALC_WORD(~0));
	y = b9361_spi_readf(spi, REG_RX_FORCE_VCO_TUNE_1 + offs, FORCE_VCO_TUNE);
	val[15] = (x << 1) | y;

	return b9361_fastlock_load(phy, tx, profile, val);
}
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_fastlock_prepare(struct b9361_rf_phy *phy, bool tx,
				       uint32_t profile, bool prepare)
{
	...
	if (prepare && !is_prepared) {
		...
		b9361_spi_write(phy->spi, REG_RX_FAST_LOCK_SETUP + offs,
				 RX_FAST_LOCK_PROFILE(profile) |
				 RX_FAST_LOCK_MODE_ENABLE);
		b9361_spi_write(phy->spi, REG_RX_FAST_LOCK_PROGRAM_CTRL + offs,
				 0);

		b9361_spi_writef(phy->spi, REG_ENSM_CONFIG_2, ready_mask, 1);
		b9361_trx_vco_cal_control(phy, tx, false);
	} else if (!prepare && is_prepared) {
		b9361_spi_write(phy->spi, REG_RX_FAST_LOCK_SETUP + offs, 0);

		/* Workaround: Exiting Fastlock Mode */
		b9361_spi_writef(phy->spi, REG_RX_FORCE_ALC + offs, FORCE_ALC_ENABLE, 1);
		b9361_spi_writef(phy->spi, REG_RX_FORCE_VCO_TUNE_1 + offs, FORCE_VCO_TUNE, 1);
		b9361_spi_writef(phy->spi, REG_RX_FORCE_ALC + offs, FORCE_ALC_ENABLE, 0);
		b9361_spi_writef(phy->spi, REG_RX_FORCE_VCO_TUNE_1 + offs, FORCE_VCO_TUNE, 0);

		b9361_trx_vco_cal_control(phy, tx, true);
		b9361_spi_writef(phy->spi, REG_ENSM_CONFIG_2, ready_mask, 0);
			       ...
			       uint32_t profile)
{
	...
	if (current_profile == 0)
		curr = b9361_spi_readf(phy->spi, REG_RX_FORCE_ALC + offs,
					FORCE_ALC_WORD(~0)) << 1;
	else
	...
	if ((curr >> 1) == (_new >> 1)) {
		...
		b9361_fastlock_writeval(phy->spi, tx, profile, 0xF,
					 phy->fastlock.entry[tx][profile].alc_written, true);
	}

	b9361_fastlock_prepare(phy, tx, profile, true);
	phy->fastlock.current_profile[tx] = profile + 1;

	return b9361_spi_write(phy->spi, REG_RX_FAST_LOCK_SETUP + offs,
				RX_FAST_LOCK_PROFILE(profile) |
			     ...
			     uint32_t profile, uint8_t *values)
{
	...
	for (i = 0; i < RX_FAST_LOCK_CONFIG_WORD_NUM; i++)
		values[i] = b9361_fastlock_readval(phy->spi, tx, profile, i);
...
int32_t b9361_mcs(struct b9361_rf_phy *phy, int32_t step)
{
	...
	case 1:
		...
		*/
		...
		b9361_spi_writef(phy->spi, REG_MULTICHIP_SYNC_AND_TX_MON_CTRL,
				  mcs_mask, MCS_BB_ENABLE | MCS_BBPLL_ENABLE | MCS_RF_ENABLE);
		b9361_spi_writef(phy->spi, REG_CP_BLEED_CURRENT,
 ...
 * @return None.
 */
void b9361_clear_state(struct b9361_rf_phy *phy)
{
 ...
 */
static uint32_t b9361_ref_div_sel(uint32_t refin_Hz, uint32_t max)
{
	if (refin_Hz <= (max / 2))
		return 2 * refin_Hz;
...
int32_t b9361_setup(struct b9361_rf_phy *phy)
{
	...
	pd->rf_rx_bandwidth_Hz = b9361_validate_rf_bw(phy, pd->rf_rx_bandwidth_Hz);
	pd->rf_tx_bandwidth_Hz = b9361_validate_rf_bw(phy, pd->rf_tx_bandwidth_Hz);
	...
	b9361_spi_write(spi, REG_CTRL, CTRL_ENABLE);
	b9361_spi_write(spi, REG_BANDGAP_CONFIG0,
			 MASTER_BIAS_TRIM(0x0E)); /* Enable Master Bias */
	b9361_spi_write(spi, REG_BANDGAP_CONFIG1,
			 BANDGAP_TEMP_TRIM(0x0E)); /* Set Bandgap Trim */

	b9361_set_dcxo_tune(phy, pd->dcxo_coarse, pd->dcxo_fine);

	refin_Hz = phy->clk_refin->rate;

	ref_freq = b9361_ref_div_sel(refin_Hz, MAX_BBPLL_FREF);
	if (!ref_freq)
		return -EINVAL;

	b9361_spi_writef(spi, REG_REF_DIVIDE_CONFIG_1, RX_REF_RESET_BAR, 1);
	b9361_spi_writef(spi, REG_REF_DIVIDE_CONFIG_2, TX_REF_RESET_BAR, 1);
	/* b9361 revision */
	b9361_spi_writef(spi, REG_REF_DIVIDE_CONFIG_2,
			  TX_REF_DOUBLER_FB_DELAY(~0), 2); /* FB DELAY */
	b9361_spi_writef(spi, REG_REF_DIVIDE_CONFIG_2,
			  RX_REF_DOUBLER_FB_DELAY(~0), 2); /* FB DELAY */
	...
	ret = b9361_set_trx_clock_chain(phy, pd->rx_path_clks,
					 pd->tx_path_clks);
	if (ret < 0)
		return ret;
	...
	if (!pd->rx2tx2) {
		...
		b9361_en_dis_tx(phy, TX_1 | TX_2, pd->rx1tx1_mode_use_tx_num);
		b9361_en_dis_rx(phy, TX_1 | TX_2, pd->rx1tx1_mode_use_rx_num);
	} else {
		b9361_en_dis_tx(phy, TX_1 | TX_2, TX_1 | TX_2);
		b9361_en_dis_rx(phy, RX_1 | RX_2, RX_1 | RX_2);
	}

	ret = b9361_rf_port_setup(phy, true, pd->rf_rx_input_sel,
				   pd->rf_tx_output_sel);
	if (ret < 0)
		return ret;

	ret = b9361_pp_port_setup(phy, false);
	if (ret < 0)
		return ret;

	ret = b9361_auxdac_setup(phy, &pd->auxdac_ctrl);
	if (ret < 0)
		return ret;

	bbpll_freq = clk_get_rate(phy, phy->ref_clk_scale[BBPLL_CLK]);
	ret = b9361_auxadc_setup(phy, &pd->auxadc_ctrl, bbpll_freq);
	if (ret < 0)
		return ret;

	ret = b9361_ctrl_outs_setup(phy, &pd->ctrl_outs_ctrl);
	if (ret < 0)
		return ret;

	ret = b9361_gpo_setup(phy, &pd->gpo_ctrl);
	if (ret < 0)
		return ret;

	ret = b9361_set_ref_clk_cycles(phy, refin_Hz);
	if (ret < 0)
		return ret;

	ret = b9361_setup_ext_lna(phy, &pd->elna_ctrl);
	if (ret < 0)
		return ret;
	...
	ref_freq = b9361_ref_div_sel(refin_Hz, pd->trx_synth_max_fref);
	if (!ref_freq)
		return -EINVAL;
	...
	ret = b9361_txrx_synth_cp_calib(phy, ref_freq, false); /* RXCP */
	if (ret < 0)
		return ret;

	ret = b9361_txrx_synth_cp_calib(phy, ref_freq, true); /* TXCP */
	if (ret < 0)
		return ret;
	...
	b9361_clk_mux_set_parent(phy->ref_clk_scale[RX_RFPLL],
				  pd->use_ext_rx_lo);

	b9361_clk_mux_set_parent(phy->ref_clk_scale[TX_RFPLL],
				  pd->use_ext_tx_lo);

	ret = b9361_load_mixer_gm_subtable(phy);
	if (ret < 0)
		return ret;

	ret = b9361_gc_setup(phy, &pd->gain_ctrl);
	if (ret < 0)
		return ret;
	...
	ret = b9361_bb_dc_offset_calib(phy);
	if (ret < 0)
		return ret;

	ret = b9361_rf_dc_offset_calib(phy,
					b9361_from_clk(clk_get_rate(phy, phy->ref_clk_scale[RX_RFPLL])));
	if (ret < 0)
		return ret;
	...
	ret = b9361_tx_quad_calib(phy, real_rx_bandwidth, real_tx_bandwidth, -1);
	if (ret < 0)
		return ret;
	...
	if (!pd->fdd)
		b9361_run_calibration(phy, TXMON_CAL);

	b9361_pp_port_setup(phy, true);

	ret = b9361_set_ensm_mode(phy, pd->fdd, pd->ensm_pin_ctrl);
	if (ret < 0)
		return ret;

	b9361_spi_writef(phy->spi, REG_TX_ATTEN_OFFSET,
			  MASK_CLR_ATTEN_UPDATE, 0);

	ret = b9361_set_tx_atten(phy, pd->tx_atten,
	...
	if (!pd->rx2tx2) {
		ret = b9361_set_tx_atten(phy, 89750,
	...
	ret = b9361_rssi_setup(phy, &pd->rssi_ctrl, false);
	if (ret < 0)
		return ret;

	ret = b9361_clkout_control(phy, pd->b9361_clkout_mode);
	if (ret < 0)
		return ret;


	ret = b9361_txmon_setup(phy, &pd->txmon_ctrl);
	if (ret < 0)
		return ret;

	phy->curr_ensm_state = b9361_spi_readf(spi, REG_STATE, ENSM_STATE(~0));
	b9361_ensm_set_state(phy, pd->fdd ? ENSM_STATE_FDD : ENSM_STATE_RX,
			      pd->ensm_pin_ctrl);
			    ...
			    int32_t arg)
{
	...
	ret = b9361_tracking_control(phy, false, false, false);
	if (ret < 0)
		return ret;
	...
	switch (cal) {
	case TX_QUAD_CAL:
		ret = b9361_tx_quad_calib(phy, phy->current_rx_bw_Hz / 2,
				   ...
				   uint32_t rf_rx_bw, uint32_t rf_tx_bw)
{
	...
	ret = __b9361_update_rf_bandwidth(phy, rf_rx_bw, rf_tx_bw);
	if (ret < 0)
		return ret;
	...
	ret = b9361_tx_quad_calib(phy, rf_rx_bw / 2, rf_tx_bw / 2, -1);
	if (ret < 0)
		return ret;
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_verify_fir_filter_coef(struct b9361_rf_phy *phy,
		enum fir_dest dest,
		uint32_t ntaps, short *coef)
{
	...
	if (dest & FIR_IS_RX) {
		gain = b9361_spi_read(spi, REG_RX_FILTER_GAIN);
		offs = REG_RX_FILTER_COEF_ADDR - REG_TX_FILTER_COEF_ADDR;
		b9361_spi_write(spi, REG_RX_FILTER_GAIN, 0);
	}

	conf = b9361_spi_read(spi, REG_TX_FILTER_CONF + offs);
	...
	for (; cnt > 0; cnt--, sel++) {
		...
		b9361_spi_write(spi, REG_TX_FILTER_CONF + offs,
				 FIR_NUM_TAPS(ntaps / 16 - 1) |
				 FIR_SELECT(sel) | FIR_START_CLK);
		for (val = 0; val < ntaps; val++) {
			short tmp;
			b9361_spi_write(spi, REG_TX_FILTER_COEF_ADDR + offs, val);

			tmp = (b9361_spi_read(spi, REG_TX_FILTER_COEF_READ_DATA_1 + offs) & 0xFF) |
			      (b9361_spi_read(spi, REG_TX_FILTER_COEF_READ_DATA_2 + offs) << 8);
	...
	if (dest & FIR_IS_RX) {
		b9361_spi_write(spi, REG_RX_FILTER_GAIN, gain);
	}

	b9361_spi_write(spi, REG_TX_FILTER_CONF + offs, conf);
				    ...
				    uint32_t ntaps, int16_t *coef)
{
	...
	if (dest & FIR_IS_RX) {
		val = 3 - (gain_dB + 12) / 6;
		b9361_spi_write(spi, REG_RX_FILTER_GAIN, val & 0x3);
		offs = REG_RX_FILTER_COEF_ADDR - REG_TX_FILTER_COEF_ADDR;
		phy->rx_fir_ntaps = ntaps;
		fir_enable = b9361_spi_readf(phy->spi,
	...
	b9361_spi_write(spi, REG_TX_FILTER_CONF + offs, fir_conf);

	for (val = 0; val < ntaps; val++) {
		b9361_spi_write(spi, REG_TX_FILTER_COEF_ADDR + offs, val);
		b9361_spi_write(spi, REG_TX_FILTER_COEF_WRITE_DATA_1 + offs,
				 coef[val] & 0xFF);
		b9361_spi_write(spi, REG_TX_FILTER_COEF_WRITE_DATA_2 + offs,
				 coef[val] >> 8);
		b9361_spi_write(spi, REG_TX_FILTER_CONF + offs,
				 fir_conf | FIR_WRITE);
		b9361_spi_write(spi, REG_TX_FILTER_COEF_READ_DATA_2 + offs, 0);
		b9361_spi_write(spi, REG_TX_FILTER_COEF_READ_DATA_2 + offs, 0);
	}
	...
	return b9361_verify_fir_filter_coef(phy, dest, ntaps, coef);
}
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
int32_t b9361_parse_fir(struct b9361_rf_phy *phy,
			 char *data, uint32_t size)
{
	...
	case FIR_TX1_TX2:
		...
		ret = b9361_load_fir_filter_coef(phy, (enum fir_dest)tx, tx_gain, i, coef_tx);
		break;
	default:
		ret = -EINVAL;
	}
	...
	case FIR_RX1_RX2:
		...
		ret = b9361_load_fir_filter_coef(phy, (enum fir_dest)(rx | FIR_IS_RX),
						  rx_gain, i, coef_rx);
		break;
	default:
		ret = -EINVAL;
...
int32_t b9361_validate_enable_fir(struct b9361_rf_phy *phy)
{
	...
	if (!phy->filt_valid || phy->bypass_rx_fir || phy->bypass_tx_fir) {
		ret = b9361_calculate_rf_clock_chain(phy,
		...
		if (ret < 0) {
			...
			ret = b9361_calculate_rf_clock_chain(phy, min,
							      phy->rate_governor, rx, tx);
			if (ret < 0) {
				return ret;
			}
	...
	ret = b9361_set_trx_clock_chain(phy, rx, tx);
	if (ret < 0)
		return ret;

	/* See also: b9361_set_trx_clock_chain() */
	if (!phy->pdata->dig_interface_tune_fir_disable &&
	    phy->bypass_tx_fir && phy->bypass_rx_fir)
		b9361_dig_tune(phy, 0, RESTORE_DEFAULT);

	return b9361_update_rf_bandwidth(phy,
...
* @return 0 in case of success, negative error code otherwise.
*/
static inline int32_t b9361_set_muldiv(struct refclk_scale *priv, uint32_t mul,
					uint32_t div)
{
	priv->mult = mul;
	priv->div = div;
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_get_clk_scaler(struct refclk_scale *clk_priv)
{
	...
	case BB_REFCLK:
		tmp = b9361_spi_read(spi, REG_CLOCK_CTRL);
		tmp &= 0x3;
		break;
	case RX_REFCLK:
		tmp = b9361_spi_readf(spi, REG_REF_DIVIDE_CONFIG_1,
				       RX_REF_DIVIDER_MSB);
		tmp1 = b9361_spi_readf(spi, REG_REF_DIVIDE_CONFIG_2,
					RX_REF_DIVIDER_LSB);
		tmp = (tmp << 1) | tmp1;
		break;
	case TX_REFCLK:
		tmp = b9361_spi_readf(spi, REG_REF_DIVIDE_CONFIG_2,
				       TX_REF_DIVIDER(~0));
		break;
	case ADC_CLK:
		tmp = b9361_spi_read(spi, REG_BBPLL);
		return b9361_set_muldiv(clk_priv, 1, 1 << (tmp & 0x7));
	case R2_CLK:
		tmp = b9361_spi_readf(spi, REG_RX_ENABLE_FILTER_CTRL,
				       DEC3_ENABLE_DECIMATION(~0));
		return b9361_set_muldiv(clk_priv, 1, tmp + 1);
	case R1_CLK:
		tmp = b9361_spi_readf(spi, REG_RX_ENABLE_FILTER_CTRL, RHB2_EN);
		return b9361_set_muldiv(clk_priv, 1, tmp + 1);
	case CLKRF_CLK:
		tmp = b9361_spi_readf(spi, REG_RX_ENABLE_FILTER_CTRL, RHB1_EN);
		return b9361_set_muldiv(clk_priv, 1, tmp + 1);
	case RX_SAMPL_CLK:
		tmp = b9361_spi_readf(spi, REG_RX_ENABLE_FILTER_CTRL,
				       RX_FIR_ENABLE_DECIMATION(~0));
		...
		return b9361_set_muldiv(clk_priv, 1, tmp);
	case DAC_CLK:
		tmp = b9361_spi_readf(spi, REG_BBPLL, BIT(3));
		return b9361_set_muldiv(clk_priv, 1, tmp + 1);
	case T2_CLK:
		tmp = b9361_spi_readf(spi, REG_TX_ENABLE_FILTER_CTRL,
				       THB3_ENABLE_INTERP(~0));
		return b9361_set_muldiv(clk_priv, 1, tmp + 1);
	case T1_CLK:
		tmp = b9361_spi_readf(spi, REG_TX_ENABLE_FILTER_CTRL, THB2_EN);
		return b9361_set_muldiv(clk_priv, 1, tmp + 1);
	case CLKTF_CLK:
		tmp = b9361_spi_readf(spi, REG_TX_ENABLE_FILTER_CTRL, THB1_EN);
		return b9361_set_muldiv(clk_priv, 1, tmp + 1);
	case TX_SAMPL_CLK:
		tmp = b9361_spi_readf(spi, REG_TX_ENABLE_FILTER_CTRL,
				       TX_FIR_ENABLE_INTERPOLATION(~0));
	...
	switch (tmp) {
	case 0:
		b9361_set_muldiv(clk_priv, 1, 1);
		break;
	case 1:
		b9361_set_muldiv(clk_priv, 1, 2);
		break;
	case 2:
		b9361_set_muldiv(clk_priv, 1, 4);
		break;
	case 3:
		b9361_set_muldiv(clk_priv, 2, 1);
		break;
	default:
		return -EINVAL;
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_to_refclk_scaler(struct refclk_scale *clk_priv)
{
	/* REFCLK Scaler */
 ...
 * @return 0 in case of success, negative error code otherwise.
 */
static int32_t b9361_set_clk_scaler(struct refclk_scale *clk_priv, bool set)
{
	struct spi_device *spi = clk_priv->spi;
	uint32_t tmp;
	int32_t ret;
	...
	switch (clk_priv->source) {
	case BB_REFCLK:
		ret = b9361_to_refclk_scaler(clk_priv);
		if (ret < 0)
			return ret;
		if (set)
			return b9361_spi_writef(spi, REG_CLOCK_CTRL,
	...
	case RX_REFCLK:
		...
		if (set) {
			tmp = ret;
			ret = b9361_spi_writef(spi, REG_REF_DIVIDE_CONFIG_1,
						RX_REF_DIVIDER_MSB, tmp >> 1);
			ret |= b9361_spi_writef(spi, REG_REF_DIVIDE_CONFIG_2,
	...
	case TX_REFCLK:
		...
		if (ret < 0)
			return ret;
		if (set)
			return b9361_spi_writef(spi, REG_REF_DIVIDE_CONFIG_2,
	...
	case ADC_CLK:
		...
		if (set)
			return b9361_spi_writef(spi, REG_BBPLL, 0x7, tmp);
		break;
	case R2_CLK:
		if (clk_priv->mult != 1 || clk_priv->div > 3 || clk_priv->div < 1)
			return -EINVAL;
		if (set)
			return b9361_spi_writef(spi, REG_RX_ENABLE_FILTER_CTRL,
						 DEC3_ENABLE_DECIMATION(~0),
						 clk_priv->div - 1);
		break;
	case R1_CLK:
	...
	case DAC_CLK:
		if (clk_priv->mult != 1 || clk_priv->div > 2 || clk_priv->div < 1)
			return -EINVAL;
		if (set)
			return b9361_spi_writef(spi, REG_BBPLL,
	...
	case T2_CLK:
		if (clk_priv->mult != 1 || clk_priv->div > 3 || clk_priv->div < 1)
			return -EINVAL;
		if (set)
			return b9361_spi_writef(spi, REG_TX_ENABLE_FILTER_CTRL,
						 THB3_ENABLE_INTERP(~0),
						 clk_priv->div - 1);
		break;
	case T1_CLK:
				     ...
				     uint32_t *prate)
{
	...
	ret = b9361_set_clk_scaler(clk_priv, false);
	if (ret < 0)
		return ret;
				   ...
				   uint32_t parent_rate)
{
	...
	return b9361_set_clk_scaler(clk_priv, true);
}
				  ...
				  uint32_t parent_rate)
{
	...
	b9361_spi_readm(clk_priv->spi, REG_INTEGER_BB_FREQ_WORD, &buf[0],
			      ...
			      uint32_t parent_rate)
{
	...
	*/
	...
	b9361_spi_write(spi, REG_INTEGER_BB_FREQ_WORD, integer);
	b9361_spi_write(spi, REG_FRACT_BB_FREQ_WORD_3, fract);
	b9361_spi_write(spi, REG_FRACT_BB_FREQ_WORD_2, fract >> 8);
	b9361_spi_write(spi, REG_FRACT_BB_FREQ_WORD_1, fract >> 16);

	b9361_spi_write(spi, REG_SDM_CTRL_1,
			 INIT_BB_FO_CAL | BBPLL_RESET_BAR); /* Start BBPLL Calibration */
	b9361_spi_write(spi, REG_SDM_CTRL_1,
			 BBPLL_RESET_BAR); /* Clear BBPLL start calibration bit */

	/* b9361 bbpll revision */
	/* debug */
	b9361_spi_write(spi, REG_VCO_PROGRAM_2, 0x00);
	b9361_spi_write(spi, REG_VCO_PROGRAM_1, 0x01);
	b9361_spi_write(spi, REG_VCO_PROGRAM_2, 0x04);

	/* kvco = 0110 */
	b9361_spi_write(spi, REG_VCO_PROGRAM_2, 0x01); /* Increase BBPLL KV and phase margin */
	b9361_spi_write(spi, REG_VCO_PROGRAM_1, 0x86); /* Increase BBPLL KV and phase margin */
	b9361_spi_write(spi, REG_VCO_PROGRAM_2, 0x05); /* Increase BBPLL KV and phase margin */

	/* vco bias = 0110 */
	b9361_spi_write(spi, REG_VCO_PROGRAM_2, 0x01);
	b9361_spi_write(spi, REG_VCO_PROGRAM_1, 0xc6);
	b9361_spi_write(spi, REG_VCO_PROGRAM_2, 0x05);

	/* band2 */
	b9361_spi_write(spi, REG_VCO_PROGRAM_2, 0x00);
	b9361_spi_write(spi, REG_VCO_PROGRAM_1, 0xDB);
	b9361_spi_write(spi, REG_VCO_PROGRAM_2, 0x04);

	/* band3 */
	b9361_spi_write(spi, REG_VCO_PROGRAM_2, 0x01);
	b9361_spi_write(spi, REG_VCO_PROGRAM_1, 0x22);
	b9361_spi_write(spi, REG_VCO_PROGRAM_2, 0x05);

	/* band1 */
	b9361_spi_write(spi, REG_VCO_PROGRAM_2, 0x00);
	b9361_spi_write(spi, REG_VCO_PROGRAM_1, 0x95);
	b9361_spi_write(spi, REG_VCO_PROGRAM_2, 0x04);

	/* band0 */
	b9361_spi_write(spi, REG_VCO_PROGRAM_2, 0x00);
	b9361_spi_write(spi, REG_VCO_PROGRAM_1, 0x50);
	b9361_spi_write(spi, REG_VCO_PROGRAM_2, 0x04);

	/* band4 */
	b9361_spi_write(spi, REG_VCO_PROGRAM_2, 0x01);
	b9361_spi_write(spi, REG_VCO_PROGRAM_1, 0x6A);
	b9361_spi_write(spi, REG_VCO_PROGRAM_2, 0x05);

	return b9361_check_cal_done(clk_priv->phy, REG_CH_1_OVERFLOW,
				     BBPLL_LOCK, 1);
}
 ...
 */
static uint64_t b9361_calc_rfpll_int_freq(uint64_t parent_rate,
		uint64_t integer,
 ...
 * @return The RFPLL frequency.
 */
static int32_t b9361_calc_rfpll_int_divder(struct b9361_rf_phy *phy,
		...
		uint32_t *fract, int32_t *vco_div, uint64_t *vco_freq)
{
	...
	ret = b9361_validate_rfpll(phy, freq);
	if (ret)
		return ret;
...
uint32_t b9361_rfpll_int_recalc_rate(struct refclk_scale *clk_priv,
				      uint32_t parent_rate)
{
	struct b9361_rf_phy *phy = clk_priv->phy;
	uint32_t fract, integer;
	uint8_t buf[5];
	...
	if (profile) {
		...
		buf[0] = b9361_fastlock_readval(phy->spi, tx, profile, 4);
		buf[1] = b9361_fastlock_readval(phy->spi, tx, profile, 3);
		buf[2] = b9361_fastlock_readval(phy->spi, tx, profile, 2);
		buf[3] = b9361_fastlock_readval(phy->spi, tx, profile, 1);
		buf[4] = b9361_fastlock_readval(phy->spi, tx, profile, 0);
		vco_div = b9361_fastlock_readval(phy->spi, tx, profile, 12) & 0xF;

	} else {
		b9361_spi_readm(clk_priv->spi, reg, &buf[0], ARRAY_SIZE(buf));
		vco_div = b9361_spi_readf(clk_priv->spi, REG_RFPLL_DIVIDERS, div_mask);
	}

	fract = (SYNTH_FRACT_WORD(buf[0]) << 16) | (buf[1] << 8) | buf[2];
	integer = (SYNTH_INTEGER_WORD(buf[3]) << 8) | buf[4];

	return b9361_to_clk(b9361_calc_rfpll_int_freq(parent_rate, integer,
			     fract, vco_div));
}
				    ...
				    uint32_t *prate)
{
	...
	if (b9361_from_clk(rate) > MAX_CARRIER_FREQ_HZ ||
	    b9361_from_clk(rate) < MIN_CARRIER_FREQ_HZ)
		return -EINVAL;
				  ...
				  uint32_t parent_rate)
{
	...
	b9361_fastlock_prepare(phy, clk_priv->source == TX_RFPLL_INT, 0, false);

	ret = b9361_calc_rfpll_int_divder(phy, b9361_from_clk(rate), parent_rate,
	...
	if (phy->pdata->tdd_skip_vco_cal)
		b9361_trx_vco_cal_control(phy, clk_priv->source == TX_RFPLL_INT,
					   true);

	do {
		fixup_other = 0;
		b9361_rfpll_vco_init(phy, div_mask == TX_VCO_DIVIDER(~0),
				      vco, parent_rate);
		...
		buf[3] = SYNTH_INTEGER_WORD(integer >> 8) |
			 (~SYNTH_INTEGER_WORD(~0) &
			  b9361_spi_read(clk_priv->spi, reg - 3));
		buf[4] = integer & 0xFF;

		b9361_spi_writem(clk_priv->spi, reg, buf, 5);
		b9361_spi_writef(clk_priv->spi, REG_RFPLL_DIVIDERS, div_mask, vco_div);

		ret = b9361_check_cal_done(phy, lock_reg, VCO_LOCK, 1);
		...
		if (((phy->pdata->fdd && !phy->pdata->fdd_independent_mode)  &&
			...
			if (phy->current_tx_lo_freq != phy->current_rx_lo_freq) {
				b9361_calc_rfpll_int_divder(phy, b9361_from_clk(_rate),
							     parent_rate, &integer, &fract, &vco_div, &vco);

				b9361_fastlock_prepare(phy, clk_priv->source == RX_RFPLL_INT, 0, false);
			}
...
uint32_t b9361_rfpll_recalc_rate(struct refclk_scale *clk_priv)
{
	...
	case RX_RFPLL:
		if (phy->pdata->use_ext_rx_lo) {
			if (phy->b9361_rfpll_ext_recalc_rate)
				rate = phy->b9361_rfpll_ext_recalc_rate(clk_priv);
			else
				rate = b9361_rfpll_dummy_recalc_rate(phy->ref_clk_scale[RX_RFPLL_DUMMY]);
		} else {
			rate = b9361_rfpll_int_recalc_rate(phy->ref_clk_scale[RX_RFPLL_INT],
	...
	case TX_RFPLL:
		if (phy->pdata->use_ext_tx_lo) {
			if (phy->b9361_rfpll_ext_recalc_rate)
				...
				rate = b9361_rfpll_dummy_recalc_rate(phy->ref_clk_scale[TX_RFPLL_DUMMY]);
		} else {
			rate = b9361_rfpll_int_recalc_rate(phy->ref_clk_scale[TX_RFPLL_INT],
...
int32_t b9361_rfpll_round_rate(struct refclk_scale *clk_priv, uint32_t rate)
{
	...
	case RX_RFPLL:
		if (phy->pdata->use_ext_rx_lo) {
			if (phy->b9361_rfpll_ext_round_rate)
				round_rate = phy->b9361_rfpll_ext_round_rate(clk_priv, rate);
			else
				round_rate = rate;
		} else {
			round_rate = b9361_rfpll_int_round_rate(phy->ref_clk_scale[RX_RFPLL_INT], rate,
	...
	case TX_RFPLL:
		if (phy->pdata->use_ext_tx_lo) {
			...
			round_rate = b9361_rfpll_int_round_rate(phy->ref_clk_scale[TX_RFPLL_INT], rate,
...
int32_t b9361_rfpll_set_rate(struct refclk_scale *clk_priv, uint32_t rate)
{
	...
	case RX_RFPLL:
		if (phy->pdata->use_ext_rx_lo) {
			if (phy->b9361_rfpll_ext_set_rate)
				phy->b9361_rfpll_ext_set_rate(clk_priv, rate);
			else
				b9361_rfpll_dummy_set_rate(phy->ref_clk_scale[RX_RFPLL_DUMMY], rate);
		} else {
			b9361_rfpll_int_set_rate(phy->ref_clk_scale[RX_RFPLL_INT], rate,
						  phy->clks[phy->ref_clk_scale[RX_RFPLL_INT]->parent_source]->rate);
		}
		/* Load Gain Table */
		ret = b9361_load_gt(phy, b9361_from_clk(rate), GT_RX1 + GT_RX2);
		if (ret < 0)
			return ret;
		break;
	case TX_RFPLL:
		if (phy->pdata->use_ext_tx_lo) {
			if (phy->b9361_rfpll_ext_set_rate)
				...
				b9361_rfpll_dummy_set_rate(phy->ref_clk_scale[TX_RFPLL_DUMMY], rate);
		} else {
			b9361_rfpll_int_set_rate(phy->ref_clk_scale[TX_RFPLL_INT], rate,
						  phy->clks[phy->ref_clk_scale[TX_RFPLL_INT]->parent_source]->rate);
		}
		...
		*/
		if (phy->auto_cal_en && !phy->pdata->use_ext_tx_lo)
			if ((diff_abs(phy->last_tx_quad_cal_freq, b9361_from_clk(rate))) >
			    phy->cal_threshold_freq) {
				ret = b9361_do_calib_run(phy, TX_QUAD_CAL, -1);
				if (ret < 0)
					dev_err(&phy->spi->dev,
						"%s: TX QUAD cal failed", __func__);
				phy->last_tx_quad_cal_freq = b9361_from_clk(rate);
			}
		break;
	default:
		break;
...
int32_t b9361_clk_mux_set_parent(struct refclk_scale *clk_priv, uint8_t index)
{
	...
	ret = b9361_trx_ext_lo_control(phy, clk_priv->source == TX_RFPLL, index == 1);
	if (ret >= 0)
		clk_priv->mult = index;
 ...
 */
static struct clk *b9361_clk_register(struct b9361_rf_phy *phy,
				       const char *name,
				       ...
				       uint32_t source, uint32_t parent_source)
{
	...
	if (!clk_priv) {
		dev_err(&phy->spi->dev,
			"b9361_clk_register: could not allocate fixed factor clk");
		return (struct clk *)ERR_PTR(-ENOMEM);
	}

	/* struct refclk_scale assignments */
	clk_priv->source = (enum b9361_clocks)source;
	clk_priv->parent_source = (enum b9361_clocks)parent_source;
	...
	switch (source) {
	case TX_REFCLK:
		clk->rate = b9361_clk_factor_recalc_rate(clk_priv, phy->clk_refin->rate);
		break;
	case RX_REFCLK:
		clk->rate = b9361_clk_factor_recalc_rate(clk_priv, phy->clk_refin->rate);
		break;
	case BB_REFCLK:
		...
		break;
	case BBPLL_CLK:
		clk->rate = b9361_bbpll_recalc_rate(clk_priv, phy->clks[BB_REFCLK]->rate);
		break;
	case ADC_CLK:
		clk->rate = b9361_clk_factor_recalc_rate(clk_priv, phy->clks[BBPLL_CLK]->rate);
		break;
	case R2_CLK:
		clk->rate = b9361_clk_factor_recalc_rate(clk_priv, phy->clks[ADC_CLK]->rate);
		break;
	case R1_CLK:
		clk->rate = b9361_clk_factor_recalc_rate(clk_priv, phy->clks[R2_CLK]->rate);
		break;
	case CLKRF_CLK:
		clk->rate = b9361_clk_factor_recalc_rate(clk_priv, phy->clks[R1_CLK]->rate);
		break;
	case RX_SAMPL_CLK:
		clk->rate = b9361_clk_factor_recalc_rate(clk_priv, phy->clks[CLKRF_CLK]->rate);
		break;
	case DAC_CLK:
		clk->rate = b9361_clk_factor_recalc_rate(clk_priv, phy->clks[ADC_CLK]->rate);
		break;
	case T2_CLK:
		clk->rate = b9361_clk_factor_recalc_rate(clk_priv, phy->clks[DAC_CLK]->rate);
		break;
	case T1_CLK:
		clk->rate = b9361_clk_factor_recalc_rate(clk_priv, phy->clks[T2_CLK]->rate);
		break;
	case CLKTF_CLK:
		clk->rate = b9361_clk_factor_recalc_rate(clk_priv, phy->clks[T1_CLK]->rate);
		break;
	case TX_SAMPL_CLK:
		clk->rate = b9361_clk_factor_recalc_rate(clk_priv, phy->clks[CLKTF_CLK]->rate);
		break;
	case RX_RFPLL_INT:
		clk->rate = b9361_rfpll_int_recalc_rate(clk_priv, phy->clks[RX_REFCLK]->rate);
		break;
	case TX_RFPLL_INT:
		clk->rate = b9361_rfpll_int_recalc_rate(clk_priv, phy->clks[TX_REFCLK]->rate);
		break;
	case RX_RFPLL_DUMMY:
	...
	case TX_RFPLL_DUMMY:
		...
		break;
	case RX_RFPLL:
		clk->rate = b9361_rfpll_recalc_rate(clk_priv);
		break;
	case TX_RFPLL:
		clk->rate = b9361_rfpll_recalc_rate(clk_priv);
	}
...
int32_t register_clocks(struct b9361_rf_phy *phy)
{
	...
	phy->clk_data.clk_num = NUM_B9361_CLKS;

	/* Scaled Reference Clocks */
	phy->clks[TX_REFCLK] = b9361_clk_register(phy,
			       "tx_refclk", "b9361_ext_refclk",
			       flags | CLK_IGNORE_UNUSED,
			       TX_REFCLK, EXT_REF_CLK);

	phy->clks[RX_REFCLK] = b9361_clk_register(phy,
			       "rx_refclk", "b9361_ext_refclk",
			       flags | CLK_IGNORE_UNUSED,
			       RX_REFCLK, EXT_REF_CLK);

	phy->clks[BB_REFCLK] = b9361_clk_register(phy,
			       "bb_refclk", "b9361_ext_refclk",
			       flags | CLK_IGNORE_UNUSED,
			       BB_REFCLK, EXT_REF_CLK);

	/* Base Band PLL Clock */
	phy->clks[BBPLL_CLK] = b9361_clk_register(phy,
			       "bbpll_clk", "bb_refclk",
			       flags | CLK_IGNORE_UNUSED,
			       BBPLL_CLK, BB_REFCLK);

	phy->clks[ADC_CLK] = b9361_clk_register(phy,
			     "adc_clk", "bbpll_clk",
			     flags | CLK_IGNORE_UNUSED,
			     ADC_CLK, BBPLL_CLK);

	phy->clks[R2_CLK] = b9361_clk_register(phy,
						"r2_clk", "adc_clk",
						flags | CLK_IGNORE_UNUSED,
						R2_CLK, ADC_CLK);

	phy->clks[R1_CLK] = b9361_clk_register(phy,
						"r1_clk", "r2_clk",
						flags | CLK_IGNORE_UNUSED,
						R1_CLK, R2_CLK);

	phy->clks[CLKRF_CLK] = b9361_clk_register(phy,
			       "clkrf_clk", "r1_clk",
			       flags | CLK_IGNORE_UNUSED,
			       CLKRF_CLK, R1_CLK);

	phy->clks[RX_SAMPL_CLK] = b9361_clk_register(phy,
				  "rx_sampl_clk", "clkrf_clk",
				  flags | CLK_IGNORE_UNUSED,
				  RX_SAMPL_CLK, CLKRF_CLK);


	phy->clks[DAC_CLK] = b9361_clk_register(phy,
			     "dac_clk", "adc_clk",
			     flags | CLK_IGNORE_UNUSED,
			     DAC_CLK, ADC_CLK);

	phy->clks[T2_CLK] = b9361_clk_register(phy,
						"t2_clk", "dac_clk",
						flags | CLK_IGNORE_UNUSED,
						T2_CLK, DAC_CLK);

	phy->clks[T1_CLK] = b9361_clk_register(phy,
						"t1_clk", "t2_clk",
						flags | CLK_IGNORE_UNUSED,
						T1_CLK, T2_CLK);

	phy->clks[CLKTF_CLK] = b9361_clk_register(phy,
			       "clktf_clk", "t1_clk",
			       flags | CLK_IGNORE_UNUSED,
			       CLKTF_CLK, T1_CLK);

	phy->clks[TX_SAMPL_CLK] = b9361_clk_register(phy,
				  "tx_sampl_clk", "clktf_clk",
				  flags | CLK_IGNORE_UNUSED,
				  TX_SAMPL_CLK, CLKTF_CLK);

	phy->clks[RX_RFPLL_INT] = b9361_clk_register(phy,
				  "rx_rfpll", "rx_refclk",
				  flags | CLK_IGNORE_UNUSED,
				  RX_RFPLL_INT, RX_REFCLK);

	phy->clks[TX_RFPLL_INT] = b9361_clk_register(phy,
				  "tx_rfpll", "tx_refclk",
				  flags | CLK_IGNORE_UNUSED,
				  TX_RFPLL_INT, TX_REFCLK);

	phy->clks[RX_RFPLL_DUMMY] = b9361_clk_register(phy,
				    "rx_rfpll_dummy", NULL,
				    flags | CLK_IGNORE_UNUSED,
				    RX_RFPLL_DUMMY, 0);

	phy->clks[TX_RFPLL_DUMMY] = b9361_clk_register(phy,
				    "tx_rfpll_dummy", NULL,
				    flags | CLK_IGNORE_UNUSED,
				    TX_RFPLL_DUMMY, 0);

	phy->clks[RX_RFPLL] = b9361_clk_register(phy,
			      "rx_rfpll", NULL,
			      flags | CLK_IGNORE_UNUSED,
			      RX_RFPLL, 0);

	phy->clks[TX_RFPLL] = b9361_clk_register(phy,
			      "tx_rfpll", NULL,
			      flags | CLK_IGNORE_UNUSED,
			      TX_RFPLL, 0);
...
int32_t b9361_rssi_gain_step_calib(struct b9361_rf_phy *phy)
{
	...
	/* Put the B9361 into the Alert state. */
	b9361_ensm_force_state(phy, ENSM_STATE_ALERT);

	/* Program the directly-addressable register values. */
	b9361_spi_write(phy->spi, REG_MAX_MIXER_CALIBRATION_GAIN_INDEX,
			 MAX_MIXER_CALIBRATION_GAIN_INDEX(0x0F));
	b9361_spi_write(phy->spi, REG_MEASURE_DURATION,
			 GAIN_CAL_MEAS_DURATION(0x0E));
	b9361_spi_write(phy->spi, REG_SETTLE_TIME,
			 SETTLE_TIME(0x3F));
	b9361_spi_write(phy->spi, REG_RSSI_CONFIG,
			 RSSI_MODE_SELECT(0x3) | DEFAULT_RSSI_MEAS_MODE);
	b9361_spi_write(phy->spi, REG_MEASURE_DURATION_01,
			 MEASUREMENT_DURATION_0(0x0E));
	b9361_spi_write(phy->spi, REG_LNA_GAIN,
			 gain_step_calib_reg_val[lo_index][0]);

	/* Program the LNA gain step words into the internal table. */
	b9361_spi_write(phy->spi, REG_CONFIG,
			 CALIB_TABLE_SELECT(0x3) | START_CALIB_TABLE_CLOCK);
	for(i = 0; i < 4; i++) {
		b9361_spi_write(phy->spi, REG_WORD_ADDRESS, i);
		b9361_spi_write(phy->spi, REG_GAIN_DIFF_WORDERROR_WRITE,
	...
	b9361_spi_write(phy->spi, REG_CONFIG, START_CALIB_TABLE_CLOCK);
	b9361_spi_write(phy->spi, REG_CONFIG, 0x00);

	/* Run and wait until the calibration completes. */
	b9361_run_calibration(phy, RX_GAIN_STEP_CAL);

	/* Read the LNA and Mixer error terms into nonvolatile memory. */
	b9361_spi_write(phy->spi, REG_CONFIG, CALIB_TABLE_SELECT(0x1) | READ_SELECT);
	for(i = 0; i < 4; i++) {
		b9361_spi_write(phy->spi, REG_WORD_ADDRESS, i);
		lna_error[i] = b9361_spi_read(phy->spi, REG_GAIN_ERROR_READ);
	}
	b9361_spi_write(phy->spi, REG_CONFIG, CALIB_TABLE_SELECT(0x1));
	for(i = 0; i < 15; i++) {
		b9361_spi_write(phy->spi, REG_WORD_ADDRESS, i);
		mixer_error[i] = b9361_spi_read(phy->spi, REG_GAIN_ERROR_READ);
	}
	b9361_spi_write(phy->spi, REG_CONFIG, 0x00);

	/* Programming gain step errors into the B9361 in the field */
	b9361_spi_write(phy->spi,
			 REG_CONFIG, CALIB_TABLE_SELECT(0x3) | START_CALIB_TABLE_CLOCK);
	for(i = 0; i < 4; i++) {
		b9361_spi_write(phy->spi, REG_WORD_ADDRESS, i);
		b9361_spi_write(phy->spi, REG_GAIN_DIFF_WORDERROR_WRITE, lna_error[i]);
		b9361_spi_write(phy->spi, REG_CONFIG,
	...
	for(i = 0; i < 15; i++) {
		b9361_spi_write(phy->spi, REG_WORD_ADDRESS, i);
		b9361_spi_write(phy->spi, REG_GAIN_DIFF_WORDERROR_WRITE, mixer_error[i]);
		b9361_spi_write(phy->spi, REG_CONFIG,
